 ...
 * @author Alfons Wirtz
 */
public class ViaRule implements java.io.Serializable, org.thehellnet.tools.freerouting.board.ObjectInfoPanel.Printable
{
     ...
     */
    public boolean contains_padstack(org.thehellnet.tools.freerouting.library.Padstack p_padstack)
    {
        for (ViaInfo curr_info : this.list)
        {
