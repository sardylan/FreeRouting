...
/**
 * Contains the lists of different ViaInfo's, which can be used in org.thehellnet.tools.freerouting.interactive and automatic routing.
 *
 * @author Alfons Wirtz
 */
public class ViaInfos implements java.io.Serializable, org.thehellnet.tools.freerouting.board.ObjectInfoPanel.Printable
{
    /**
