...
package org.thehellnet.tools.freerouting.rules;

import org.thehellnet.tools.freerouting.planar.ConvexShape;

/**
 * Contains the org.thehellnet.tools.freerouting.rules and constraints required for items
 * to be inserted into a routing org.thehellnet.tools.freerouting.board
 *
 * @author Alfons Wirtz
 */
public class BoardRules implements java.io.Serializable
{
     ...
     */
    public BoardRules(org.thehellnet.tools.freerouting.board.LayerStructure p_layer_structure, ClearanceMatrix p_clearance_matrix)
    {
        layer_structure = p_layer_structure;
        clearance_matrix = p_clearance_matrix;
        nets = new Nets();
        this.trace_angle_restriction = org.thehellnet.tools.freerouting.board.AngleRestriction.FORTYFIVE_DEGREE;
    ...
    public NetClass get_default_net_class()
    {
        ...
        {
            // net org.thehellnet.tools.freerouting.rules not yet initialized
    ...
    public void create_default_via_rule(NetClass p_net_class, String p_name)
    {
        ...
        for (int i = 0; i < this.via_infos.count(); ++i)
        {
            ...
            {
                org.thehellnet.tools.freerouting.library.Padstack curr_padstack = curr_via_info.get_padstack();
    ...
    /**
     * Changes the clearance class index of all objects on the org.thehellnet.tools.freerouting.board with index p_from_no
     * to p_to_no.
     */
    public void change_clearance_class_no(int p_from_no, int p_to_no, java.util.Collection<org.thehellnet.tools.freerouting.board.Item> p_board_items)
    {
        for(org.thehellnet.tools.freerouting.board.Item curr_item : p_board_items)
        {
        ...
        {
            org.thehellnet.tools.freerouting.rules.NetClass curr_net_class = this.net_classes.get(i);
        ...
        for (int i = 0; i < this.via_infos.count(); ++i)
        {
            org.thehellnet.tools.freerouting.rules.ViaInfo curr_via = this.via_infos.get(i);
     ...
     */
    public boolean remove_clearance_class(int p_index, java.util.Collection<org.thehellnet.tools.freerouting.board.Item> p_board_items)
    {
        for(org.thehellnet.tools.freerouting.board.Item curr_item : p_board_items)
        {
    ...
    public org.thehellnet.tools.freerouting.board.AngleRestriction get_trace_angle_restriction()
    {
        return this.trace_angle_restriction;
    }
    
    /** Sets the angle restriction for tracese: 90 degree, 45 degree or none. */
    public void set_trace_angle_restriction(org.thehellnet.tools.freerouting.board.AngleRestriction p_angle_restriction)
    {
    ...
    public double get_default_via_diameter()
    {
        ...
        org.thehellnet.tools.freerouting.library.Padstack via_padstack = default_via_rule.get_via(0).get_padstack();
    ...
    throws java.io.IOException, java.lang.ClassNotFoundException
    {
        ...
        this.trace_angle_restriction = org.thehellnet.tools.freerouting.board.AngleRestriction.arr[snap_angle_no];
    }
    ...
    /**
     * Describes the electrical nets on the org.thehellnet.tools.freerouting.board.
     */
    public final Nets nets;
    
    
    /** The angle restriction for traces: 90 degree, 45 degree or none. */
    private transient org.thehellnet.tools.freerouting.board.AngleRestriction trace_angle_restriction;
    ...
    private final org.thehellnet.tools.freerouting.board.LayerStructure layer_structure;
