...
public class ClearanceMatrix implements java.io.Serializable
{
     ...
     */
    public static ClearanceMatrix get_default_instance(org.thehellnet.tools.freerouting.board.LayerStructure p_layer_structure, int p_default_value)
    {
     ...
     */
    public ClearanceMatrix(int p_class_count, org.thehellnet.tools.freerouting.board.LayerStructure p_layer_structure, String [] p_name_arr)
    {
     ...
     */
    private class Row implements org.thehellnet.tools.freerouting.board.ObjectInfoPanel.Printable, java.io.Serializable
    {
