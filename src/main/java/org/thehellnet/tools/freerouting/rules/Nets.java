...
/**
 * Describes the electrical Nets on a org.thehellnet.tools.freerouting.board.
 *
 * @author  alfons
 */
public class Nets implements java.io.Serializable
{
    ...
    /**
     * Returns the biggest net number on the org.thehellnet.tools.freerouting.board.
     */
    ...
    {
        java.util.ResourceBundle resources = java.util.ResourceBundle.getBundle("rules/Default", p_locale);
     ...
     * p_subnet_number is used only if a net is divided internally because of fromto org.thehellnet.tools.freerouting.rules for example.
     ...
     */
    public void set_board(org.thehellnet.tools.freerouting.board.BasicBoard p_board)
    {
        this.board = p_board;
    }
     ...
     * Used for example to get access to the Items of the net.
     */
    public org.thehellnet.tools.freerouting.board.BasicBoard get_board()
    {
        return this.board;
    }
    ...
    /** The list of electrical nets on the org.thehellnet.tools.freerouting.board */
    private Vector<Net> net_arr;
    private org.thehellnet.tools.freerouting.board.BasicBoard board;
}
