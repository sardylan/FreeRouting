...
import org.thehellnet.tools.freerouting.board.ObjectInfoPanel.Printable;
 ...
 * @author  Alfons Wirtz
 */
public class Net implements Comparable<Net>, org.thehellnet.tools.freerouting.board.ObjectInfoPanel.Printable, java.io.Serializable
{
    ...
    public java.util.Collection<Item> get_terminal_items()
    {
        ...
        org.thehellnet.tools.freerouting.board.BasicBoard board = this.net_list.get_board();
        ...
        for (;;)
        {
            ...
            if (curr_item instanceof org.thehellnet.tools.freerouting.board.Connectable)
            {
     ...
     */
    public java.util.Collection<org.thehellnet.tools.freerouting.board.Pin> get_pins()
    {
        java.util.Collection<org.thehellnet.tools.freerouting.board.Pin> result = new java.util.LinkedList<org.thehellnet.tools.freerouting.board.Pin>();
        org.thehellnet.tools.freerouting.board.BasicBoard board = this.net_list.get_board();
        java.util.Iterator<UndoableObjects.UndoableObjectNode> it = board.item_list.start_read_object();
        for (;;)
        {
            ...
            if (curr_item instanceof org.thehellnet.tools.freerouting.board.Pin)
            {
                ...
                {
                    result.add((org.thehellnet.tools.freerouting.board.Pin) curr_item);
                }
            }
        }
        return result;
     ...
     */
    public java.util.Collection<org.thehellnet.tools.freerouting.board.Item> get_items()
    {
        java.util.Collection<org.thehellnet.tools.freerouting.board.Item> result = new java.util.LinkedList<org.thehellnet.tools.freerouting.board.Item>();
        org.thehellnet.tools.freerouting.board.BasicBoard board = this.net_list.get_board();
        java.util.Iterator<UndoableObjects.UndoableObjectNode> it = board.item_list.start_read_object();
        for (;;)
        {
    ...
    /**
     * Returns the cumulative trace length of all traces on the org.thehellnet.tools.freerouting.board belonging to this net.
     */
    public double get_trace_length()
    {
        ...
        for (Item curr_item : net_items)
        {
            ...
            {
                cumulative_trace_length += ((org.thehellnet.tools.freerouting.board.Trace) curr_item).get_length();
            }
        }
    ...
    /**
     * Returns the count of vias on the org.thehellnet.tools.freerouting.board belonging to this net.
     */
    public int get_via_count()
    {
        ...
        for (Item curr_item : net_items)
        {
            if (curr_item instanceof org.thehellnet.tools.freerouting.board.Via)
            {
                ++result;
            }
        }
    ...
    public void print_info(org.thehellnet.tools.freerouting.board.ObjectInfoPanel p_window, java.util.Locale p_locale)
    {
    ...
    /**
     * Used only if a net is divided internally because of fromto org.thehellnet.tools.freerouting.rules for example
