...
/**
 * Contains the array of net classes for org.thehellnet.tools.freerouting.interactive routing.
 *
 * @author Alfons Wirtz
 */
public class NetClasses implements java.io.Serializable
{
     ...
     */
    NetClass append(String p_name, org.thehellnet.tools.freerouting.board.LayerStructure p_layer_structure, ClearanceMatrix p_clearance_matrix)
    {
     ...
     */
    NetClass append(org.thehellnet.tools.freerouting.board.LayerStructure p_layer_structure, ClearanceMatrix p_clearance_matrix, java.util.Locale p_locale)
    {
        java.util.ResourceBundle resources = 
                java.util.ResourceBundle.getBundle("rules/Default", p_locale);
