...
/**
 * Describes routing org.thehellnet.tools.freerouting.rules for individual nets.
 *
 * @author Alfons Wirtz
 */
public class NetClass implements java.io.Serializable, org.thehellnet.tools.freerouting.board.ObjectInfoPanel.Printable
{

    /** Creates a new instance of NetClass */
    public NetClass(String p_name, org.thehellnet.tools.freerouting.board.LayerStructure p_layer_structure, ClearanceMatrix p_clearance_matrix)
    {
        this.name = p_name;
    ...
    private final org.thehellnet.tools.freerouting.board.LayerStructure board_layer_structure;
    /**
     * The clearance classes of the item types, if this net class comes from a class in a Speccctra dsn-file
     * Should evtl be moved to org.thehellnet.tools.freerouting.specctra.NetClass and used only when reading a dsn-file.
     */
