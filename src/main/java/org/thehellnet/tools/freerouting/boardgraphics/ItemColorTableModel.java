...
/**
 * Stores the layer dependent colors used for drawing for the items on the org.thehellnet.tools.freerouting.board.
 *
 * @author Alfons Wirtz
 */
public class ItemColorTableModel extends ColorTableModel implements java.io.Serializable
{
    ...
    public ItemColorTableModel(org.thehellnet.tools.freerouting.board.LayerStructure p_layer_structure, java.util.Locale p_locale)
    {
    ...
    public String getColumnName(int p_col)
    {
        java.util.ResourceBundle resources = 
                java.util.ResourceBundle.getBundle("boardgraphics/ColorTableModel", this.locale);
