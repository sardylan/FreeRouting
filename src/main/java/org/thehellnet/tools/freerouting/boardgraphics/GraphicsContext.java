...
import org.thehellnet.tools.freerouting.planar.Circle;
...
/**
 * Context for drawing items in the org.thehellnet.tools.freerouting.board package to the screen.
 *
 * @author Alfons Wirtz
 */
...
public class GraphicsContext implements java.io.Serializable
{
    public GraphicsContext(IntBox p_design_bounds,
                           Dimension p_panel_bounds, org.thehellnet.tools.freerouting.board.LayerStructure p_layer_structure, java.util.Locale p_locale)
    {
    ...
    /**
     *  Changes  the bounds of the org.thehellnet.tools.freerouting.board design to p_design_bounds.
    ...
    /**
     * draws the interiour of an item of class org.thehellnet.tools.freerouting.planar.Area
     */
    ...
    /** Returns the number of layers on the org.thehellnet.tools.freerouting.board */
