...
package org.thehellnet.tools.freerouting.boardgraphics;

import org.thehellnet.tools.freerouting.planar.FloatPoint;
import org.thehellnet.tools.freerouting.planar.IntBox;
import org.thehellnet.tools.freerouting.planar.Limits;

import java.awt.Dimension;
import java.awt.geom.Point2D;

/**
 * Transformation function between the org.thehellnet.tools.freerouting.board and the screen coordinate systems.
 *
 * @author Alfons Wirtz
 */
...
public class CoordinateTransform implements java.io.Serializable
{
    ...
    /**
     * scale a value from the org.thehellnet.tools.freerouting.board to the screen coordinate system
     */
    ...
    /**
     * scale a value the screen to the org.thehellnet.tools.freerouting.board coordinate system
     */
    ...
    /**
     * transform a org.thehellnet.tools.freerouting.planar.FloatPoint to a java.awt.geom.Point2D
     */
    ...
    /**
     * Transform a java.awt.geom.Point2D to a org.thehellnet.tools.freerouting.planar.FloatPoint
     */
    ...
    /**
     * Transforms an angle in radian on the org.thehellnet.tools.freerouting.board to an angle on the screen.
     */
    ...
    /**
     * Transform a org.thehellnet.tools.freerouting.planar.IntBox to a java.awt.Rectangle
    ...
    /**
     * Transform a java.awt.Rectangle to a org.thehellnet.tools.freerouting.planar.IntBox
    ...
    /**
     * If p_value is true, the left side and the right side of the org.thehellnet.tools.freerouting.board will be swapped.
     */
    ...
    /**
     * Returns, if the left side and the right side of the org.thehellnet.tools.freerouting.board are swapped.
     */
    ...
    /**
     * If p_value is true, the top side and the botton side of the org.thehellnet.tools.freerouting.board will be swapped.
     */
    ...
    /**
     * Returns, if the top side and the botton side of the org.thehellnet.tools.freerouting.board are swapped.
     */
    ...
    /**
     * Sets the rotation of the displayed org.thehellnet.tools.freerouting.board to p_value.
     */
    ...
    /**
     * Returns the rotation of the displayed org.thehellnet.tools.freerouting.board.
     */
    ...
    /**
     * Left side and right side of the org.thehellnet.tools.freerouting.board are swapped.
     */
    private boolean mirror_left_right = false;
    
    /**
     * Top side and bottom  side of the org.thehellnet.tools.freerouting.board are swapped.
     */
