...
public class Layer
{
    /** all layers of the org.thehellnet.tools.freerouting.board */
            ...
            boolean p_write_rule) throws java.io.IOException
    {
        ...
        org.thehellnet.tools.freerouting.board.Layer board_layer = p_par.board.layer_structure.arr[p_layer_no];
