...
public class PartLibrary  extends ScopeKeyword
{
    ...
    {
        org.thehellnet.tools.freerouting.library.LogicalParts logical_parts = p_par.board.library.logical_parts;
        ...
        {
            org.thehellnet.tools.freerouting.library.LogicalPart curr_part =  logical_parts.get(i);
            p_par.file.start_scope();
            ...
            {
                org.thehellnet.tools.freerouting.board.Component curr_compomnent = p_par.board.components.get(j);
        ...
        for (int i = 1; i <=  logical_parts.count(); ++i)
        {
            ...
            {
                p_par.file.new_line();
                org.thehellnet.tools.freerouting.library.LogicalPart.PartPin curr_pin =  curr_part.get_pin(j);
