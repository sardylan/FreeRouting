...
public class Package
{
    ...
    public static void write_scope(WriteScopeParameter p_par, org.thehellnet.tools.freerouting.library.Package p_package) throws java.io.IOException
    {
        ...
        {
            org.thehellnet.tools.freerouting.library.Package.Pin curr_pin = p_package.get_pin(i);
            p_par.file.new_line();
            p_par.file.write("(pin ");
            org.thehellnet.tools.freerouting.library.Padstack curr_padstack = p_par.board.library.padstacks.get(curr_pin.padstack_no);
    ...
    private static void write_package_keepout(org.thehellnet.tools.freerouting.library.Package.Keepout p_keepout, WriteScopeParameter p_par,
                                              boolean p_is_via_keepout) throws java.io.IOException
    {
        Layer keepout_layer;
        if (p_keepout.layer >= 0)
        {
            org.thehellnet.tools.freerouting.board.Layer board_layer = p_par.board.layer_structure.arr[p_keepout.layer];
        ...
        if (p_keepout.area instanceof org.thehellnet.tools.freerouting.planar.Shape)
        {
            boundary_shape = (org.thehellnet.tools.freerouting.planar.Shape) p_keepout.area ;
     ...
     */
    public static void write_placement_scope(WriteScopeParameter p_par, org.thehellnet.tools.freerouting.library.Package p_package)
    throws java.io.IOException
    {
        ...
        {
            org.thehellnet.tools.freerouting.board.Component curr_component =  p_par.board.components.get(i);
    ...
    /** If false, the package is placed on the back side of the org.thehellnet.tools.freerouting.board */
