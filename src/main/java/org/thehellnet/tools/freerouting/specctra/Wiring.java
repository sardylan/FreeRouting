...
import org.thehellnet.tools.freerouting.board.Via;
import org.thehellnet.tools.freerouting.board.Trace;
...
class Wiring extends ScopeKeyword
{
    ...
    public static void write_scope(WriteScopeParameter p_par) throws java.io.IOException
    {
        ...
        for(;;)
        {
            ...
            write_conduction_area_scope(p_par, (org.thehellnet.tools.freerouting.board.ConductionArea) curr_ob);
        }
    ...
    {
        org.thehellnet.tools.freerouting.library.Padstack via_padstack = p_via.get_padstack();
        FloatPoint via_location = p_via.get_center().to_float();
        double [] via_coor = p_par.coordinate_transform.board_to_dsn(via_location);
        int net_no;
        org.thehellnet.tools.freerouting.rules.Net via_net;
    ...
    private static void write_wire_scope(WriteScopeParameter p_par, Trace p_wire) throws java.io.IOException
    {
        ...
        org.thehellnet.tools.freerouting.rules.Net wire_net = null;
    ...
    private static void write_conduction_area_scope(WriteScopeParameter p_par, org.thehellnet.tools.freerouting.board.ConductionArea  p_conduction_area) throws java.io.IOException
    {
        ...
        org.thehellnet.tools.freerouting.rules.Net curr_net = p_par.board.rules.nets.get(p_conduction_area.get_net_no(0));
        org.thehellnet.tools.freerouting.planar.Area curr_area = p_conduction_area.get_area();
        ...
        if (curr_area instanceof org.thehellnet.tools.freerouting.planar.Shape)
        {
            boundary_shape = (org.thehellnet.tools.freerouting.planar.Shape) curr_area;
    ...
    static private void write_net(org.thehellnet.tools.freerouting.rules.Net p_net, IndentFileWriter p_file, IdentifierType p_identifier_type) throws java.io.IOException
    {
        p_file.new_line();
        p_file.write("(");
    ...
    private Item read_wire_scope(ReadScopeParameter p_par)
    {
        ...
        org.thehellnet.tools.freerouting.board.FixedState fixed = org.thehellnet.tools.freerouting.board.FixedState.UNFIXED;
        ...
        org.thehellnet.tools.freerouting.rules.NetClass net_class = board.rules.get_default_net_class();
        Collection<org.thehellnet.tools.freerouting.rules.Net> found_nets = get_subnets(net_id, board.rules);
        int[] net_no_arr = new int[found_nets.size()];
        int curr_index = 0;
        for (org.thehellnet.tools.freerouting.rules.Net curr_net : found_nets)
        {
        ...
        if (border_shape != null)
        {
            ...
            {
                clearance_class_no =
                        net_class.default_item_clearance_classes.get(org.thehellnet.tools.freerouting.rules.DefaultItemClearanceClasses.ItemClass.AREA);
            }
            Collection<Shape> area = new LinkedList<Shape>();
            area.add(border_shape);
            area.addAll(hole_list);
            org.thehellnet.tools.freerouting.planar.Area conduction_area =
        ...
        else if (path instanceof PolygonPath)
        {
            ...
            {
                clearance_class_no =
                        net_class.default_item_clearance_classes.get(org.thehellnet.tools.freerouting.rules.DefaultItemClearanceClasses.ItemClass.TRACE);
            }
            ...
            for (int i = 0; i < corner_arr.length; ++i)
            {
                ...
                {
                    System.out.println("Wiring.read_wire_scope: wire corner outside org.thehellnet.tools.freerouting.board");
                    return null;
                }
    ...
    private static Collection<org.thehellnet.tools.freerouting.rules.Net> get_subnets(Net.Id p_net_id, org.thehellnet.tools.freerouting.rules.BoardRules p_rules)
    {
        Collection<org.thehellnet.tools.freerouting.rules.Net> found_nets = new LinkedList<org.thehellnet.tools.freerouting.rules.Net>();
        if (p_net_id != null)
        {
            if (p_net_id.subnet_number > 0)
            {
                org.thehellnet.tools.freerouting.rules.Net found_net = p_rules.nets.get(p_net_id.name, p_net_id.subnet_number);
                if (found_net != null)
                {
    ...
    private boolean read_via_scope(ReadScopeParameter p_par)
    {
        try
        {
            ...
            RoutingBoard board = p_par.board_handling.get_routing_board();
            org.thehellnet.tools.freerouting.library.Padstack curr_padstack = board.library.padstacks.get(padstack_name);
            ...
            if (clearance_class_no < 0)
            {
                clearance_class_no =  net_class.default_item_clearance_classes.get(org.thehellnet.tools.freerouting.rules.DefaultItemClearanceClasses.ItemClass.VIA);
            }
    ...
    private static boolean via_exists(IntPoint p_location, org.thehellnet.tools.freerouting.library.Padstack p_padstack,
            int[] p_net_no_arr, org.thehellnet.tools.freerouting.board.BasicBoard p_board)
    {
    ...
    static org.thehellnet.tools.freerouting.board.FixedState calc_fixed(Scanner p_scanner)
    {
        try
        {
            org.thehellnet.tools.freerouting.board.FixedState result = org.thehellnet.tools.freerouting.board.FixedState.UNFIXED;
            Object next_token = p_scanner.next_token();
            if (next_token == Keyword.SHOVE_FIXED)
            {
                result = org.thehellnet.tools.freerouting.board.FixedState.SHOVE_FIXED;
            }
            else if (next_token == Keyword.FIX)
            {
                result = org.thehellnet.tools.freerouting.board.FixedState.SYSTEM_FIXED;
            }
            else if (next_token != Keyword.NORMAL)
            {
                result = org.thehellnet.tools.freerouting.board.FixedState.USER_FIXED;
            }
            next_token = p_scanner.next_token();
            if (next_token != Keyword.CLOSED_BRACKET)
            {
                System.out.println("Wiring.is_fixed: ) expected");
                return org.thehellnet.tools.freerouting.board.FixedState.UNFIXED;
            }
            return result;
        }
        catch (java.io.IOException e)
