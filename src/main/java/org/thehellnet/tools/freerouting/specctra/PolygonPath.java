...
public class PolygonPath extends Path
{
    ...
    public org.thehellnet.tools.freerouting.planar.Shape transform_to_board(CoordinateTransform p_coordinate_transform)
    {
        ...
        org.thehellnet.tools.freerouting.planar.Shape result = new org.thehellnet.tools.freerouting.planar.PolygonShape(rounded_corner_arr);
        if (offset > 0)
        {
    ...
    public org.thehellnet.tools.freerouting.planar.Shape transform_to_board_rel(CoordinateTransform p_coordinate_transform)
    {
        FloatPoint [] corner_arr = new FloatPoint[this.coordinate_arr.length / 2];
        double [] curr_point = new double [2];
        for (int i = 0; i < corner_arr.length; ++i)
