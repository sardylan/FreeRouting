...
public abstract class Rule
{
    ...
    public static void write_scope(org.thehellnet.tools.freerouting.rules.NetClass p_net_class, WriteScopeParameter p_par) throws java.io.IOException
    {
    ...
    private static void write_layer_rule(org.thehellnet.tools.freerouting.rules.NetClass p_net_class, int p_layer_no, WriteScopeParameter p_par) throws java.io.IOException
    {
        p_par.file.start_scope();
        p_par.file.write("layer_rule ");
        
        org.thehellnet.tools.freerouting.board.Layer curr_board_layer = p_par.board.layer_structure.arr[p_layer_no];
    ...
    public static void write_default_rule(WriteScopeParameter p_par, int p_layer) throws java.io.IOException
    {
        ...
        int default_cl_no = org.thehellnet.tools.freerouting.rules.BoardRules.default_clearance_class();
    ...
    /**
     * Write the clearance org.thehellnet.tools.freerouting.rules, which are different from the default clearance.
     */
    ...
    {
        org.thehellnet.tools.freerouting.rules.ClearanceMatrix cl_matrix = p_par.board.rules.clearance_matrix;
    ...
    static public void write_item_clearance_class( String p_name, org.thehellnet.tools.freerouting.datastructures.IndentFileWriter p_file,
            org.thehellnet.tools.freerouting.datastructures.IdentifierType p_identifier_type) throws java.io.IOException
    {
        p_file.new_line();
