...
import org.thehellnet.tools.freerouting.planar.IntVector;
import org.thehellnet.tools.freerouting.planar.Vector;
import org.thehellnet.tools.freerouting.planar.PolygonShape;
import org.thehellnet.tools.freerouting.planar.Simplex;
...
/**
 * Class for reading and writing org.thehellnet.tools.freerouting.library scopes from dsn-files.
 *
 * @author  Alfons Wirtz
 */
public class Library extends ScopeKeyword
{
    ...
    public boolean read_scope(ReadScopeParameter p_par)
    {
        ...
        board.library.padstacks = new org.thehellnet.tools.freerouting.library.Padstacks(p_par.board_handling.get_routing_board().layer_structure);
        ...
        {
            org.thehellnet.tools.freerouting.library.Padstack[] via_padstacks = new org.thehellnet.tools.freerouting.library.Padstack[p_par.via_padstack_names.size()];
            ...
            for (int i = 0; i < via_padstacks.length; ++i)
            {
                ...
                org.thehellnet.tools.freerouting.library.Padstack curr_padstack = board.library.padstacks.get(curr_padstack_name);
            ...
            if (found_padstack_count != via_padstacks.length)
            {
                ...
                org.thehellnet.tools.freerouting.library.Padstack[] corrected_padstacks = new org.thehellnet.tools.freerouting.library.Padstack[found_padstack_count];
        ...
        // Create the org.thehellnet.tools.freerouting.library packages on the org.thehellnet.tools.freerouting.board
        board.library.packages = new org.thehellnet.tools.freerouting.library.Packages(board.library.padstacks);
        Iterator<Package> it = package_list.iterator();
        while (it.hasNext())
        {
            Package curr_package  = it.next();
            org.thehellnet.tools.freerouting.library.Package.Pin[] pin_arr = new org.thehellnet.tools.freerouting.library.Package.Pin[curr_package.pin_info_arr.length];
            for (int i = 0; i < pin_arr.length; ++i)
            {
                ...
                org.thehellnet.tools.freerouting.library.Padstack board_padstack = board.library.padstacks.get(pin_info.padstack_name);
                if (board_padstack  == null)
                {
                    System.out.println("Library.read_scope: org.thehellnet.tools.freerouting.board padstack not found");
                    return false;
                }
                pin_arr[i] = new org.thehellnet.tools.freerouting.library.Package.Pin(pin_info.pin_name, board_padstack.no, rel_coor, pin_info.rotation);
            }
            org.thehellnet.tools.freerouting.planar.Shape[] outline_arr = new org.thehellnet.tools.freerouting.planar.Shape[curr_package.outline.size()];
            ...
            org.thehellnet.tools.freerouting.library.Package.Keepout []  keepout_arr = new org.thehellnet.tools.freerouting.library.Package.Keepout [curr_package.keepouts.size()];
            ...
            for (int i = 0; i < keepout_arr.length; ++i)
            {
                ...
                org.thehellnet.tools.freerouting.planar.Area curr_area = Shape.transform_area_to_board_rel(curr_keepout.shape_list, p_par.coordinate_transform);
                keepout_arr[i] = new org.thehellnet.tools.freerouting.library.Package.Keepout(curr_keepout.area_name, curr_area, curr_layer.no);
            }
            org.thehellnet.tools.freerouting.library.Package.Keepout []  via_keepout_arr = new org.thehellnet.tools.freerouting.library.Package.Keepout [curr_package.via_keepouts.size()];
            ...
            for (int i = 0; i < via_keepout_arr.length; ++i)
            {
                ...
                Layer curr_layer = (curr_keepout.shape_list.iterator().next()).layer;
                org.thehellnet.tools.freerouting.planar.Area curr_area = Shape.transform_area_to_board_rel(curr_keepout.shape_list, p_par.coordinate_transform);
                via_keepout_arr[i] = new org.thehellnet.tools.freerouting.library.Package.Keepout(curr_keepout.area_name, curr_area, curr_layer.no);
            }
            org.thehellnet.tools.freerouting.library.Package.Keepout []  place_keepout_arr = new org.thehellnet.tools.freerouting.library.Package.Keepout [curr_package.place_keepouts.size()];
            ...
            for (int i = 0; i < place_keepout_arr.length; ++i)
            {
                ...
                Layer curr_layer = (curr_keepout.shape_list.iterator().next()).layer;
                org.thehellnet.tools.freerouting.planar.Area curr_area = Shape.transform_area_to_board_rel(curr_keepout.shape_list, p_par.coordinate_transform);
                place_keepout_arr[i] = new org.thehellnet.tools.freerouting.library.Package.Keepout(curr_keepout.area_name, curr_area, curr_layer.no);
            }
    ...
    public static void write_padstack_scope(WriteScopeParameter p_par, org.thehellnet.tools.freerouting.library.Padstack p_padstack) throws java.io.IOException
    {
        ...
        {
            org.thehellnet.tools.freerouting.planar.Shape curr_board_shape = p_padstack.get_shape(i);
            if (curr_board_shape == null)
            {
                continue;
            }
            org.thehellnet.tools.freerouting.board.Layer board_layer = p_par.board.layer_structure.arr[i];
    ...
    static boolean  read_padstack_scope(Scanner p_scanner, LayerStructure p_layer_structure,
            CoordinateTransform p_coordinate_transform, org.thehellnet.tools.freerouting.library.Padstacks p_board_padstacks)
    {
        ...
        org.thehellnet.tools.freerouting.planar.ConvexShape[] padstack_shapes = new org.thehellnet.tools.freerouting.planar.ConvexShape[p_layer_structure.arr.length];
        Iterator<Shape> it = shape_list.iterator();
        while (it.hasNext())
        {
            Shape pad_shape = it.next();
            org.thehellnet.tools.freerouting.planar.Shape curr_shape = pad_shape.transform_to_board_rel(p_coordinate_transform);
            org.thehellnet.tools.freerouting.planar.ConvexShape convex_shape;
            if (curr_shape instanceof org.thehellnet.tools.freerouting.planar.ConvexShape)
            {
                convex_shape = (org.thehellnet.tools.freerouting.planar.ConvexShape) curr_shape;
            }
            else
            {
                ...
                org.thehellnet.tools.freerouting.planar.TileShape[] convex_shapes = curr_shape.split_to_convex();
            ...
            org.thehellnet.tools.freerouting.planar.ConvexShape padstack_shape = convex_shape;
