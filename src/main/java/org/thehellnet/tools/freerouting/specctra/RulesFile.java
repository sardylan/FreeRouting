...
/**
 * File for saving the org.thehellnet.tools.freerouting.board org.thehellnet.tools.freerouting.rules, so that they can be restored after the Board
...
public class RulesFile
{
    ...
    public static void write(org.thehellnet.tools.freerouting.interactive.BoardHandling p_board_handling, java.io.OutputStream p_output_stream, String p_design_name)
    {
        ...
        {
            System.out.println("unable to write org.thehellnet.tools.freerouting.rules to file");
        }
        try
        {
            output_file.close();
        ...
        {
            System.out.println("unable to close org.thehellnet.tools.freerouting.rules file");
        }
    }
    
    public static boolean read(java.io.InputStream p_input_stream, String p_design_name, 
            org.thehellnet.tools.freerouting.interactive.BoardHandling p_board_handling)
    {
        BasicBoard routing_board = p_board_handling.get_routing_board();
        ...
        try
        {
            ...
            {
                System.out.println("RulesFile.read: keyword org.thehellnet.tools.freerouting.rules expected");
                return false;
            }
            curr_token = scanner.next_token();
        ...
        for (;;)
        {
            ...
            if (prev_token == Keyword.OPEN_BRACKET)
            {
                ...
                else if (next_token == Keyword.SNAP_ANGLE)
                {
                    ...
                    org.thehellnet.tools.freerouting.board.AngleRestriction snap_angle = Structure.read_snap_angle(scanner);
                    if (snap_angle != null)
                    {
                ...
                {
                      org.thehellnet.tools.freerouting.interactive.AutorouteSettings autoroute_settings
    ...
    private static void write_rules( WriteScopeParameter p_par, String p_design_name) throws java.io.IOException
    {
        ...
        p_par.file.write("org.thehellnet.tools.freerouting.rules PCB ");
        ...
        {
            org.thehellnet.tools.freerouting.library.Padstack curr_padstack = p_par.board.library.padstacks.get(i);
    ...
    {
        org.thehellnet.tools.freerouting.rules.ViaInfo curr_via_info = Network.read_via_info(p_scanner, p_board);
        if (curr_via_info == null)
        {
            return false;
        }
        org.thehellnet.tools.freerouting.rules.ViaInfo existing_via = p_board.rules.via_infos.get(curr_via_info.get_name());
