 ...
 */
package org.thehellnet.tools.freerouting.specctra;

import org.thehellnet.tools.freerouting.planar.IntPoint;
import org.thehellnet.tools.freerouting.planar.Point;
import org.thehellnet.tools.freerouting.planar.Vector;
...
import org.thehellnet.tools.freerouting.datastructures.IndentFileWriter;
import org.thehellnet.tools.freerouting.datastructures.IdentifierType;

import org.thehellnet.tools.freerouting.rules.BoardRules;
import org.thehellnet.tools.freerouting.rules.DefaultItemClearanceClasses.ItemClass;
import org.thehellnet.tools.freerouting.board.RoutingBoard;
...
public class Network extends ScopeKeyword
{
    ...
    public boolean read_scope(ReadScopeParameter p_par)
    {
        ...
        Collection<org.thehellnet.tools.freerouting.rules.ViaInfo> via_infos = new LinkedList<org.thehellnet.tools.freerouting.rules.ViaInfo>();
        ...
        for (;;)
        {
            ...
            if (prev_token == OPEN_BRACKET)
            {
                ...
                {
                    org.thehellnet.tools.freerouting.rules.ViaInfo curr_via_info = read_via_info(p_par.scanner, p_par.board_handling.get_routing_board());
    ...
    public static void write_scope(WriteScopeParameter p_par) throws java.io.IOException
    {
        ...
        Collection<org.thehellnet.tools.freerouting.board.Pin> board_pins = p_par.board.get_pins();
    ...
    public static void write_via_infos(org.thehellnet.tools.freerouting.rules.BoardRules p_rules, IndentFileWriter p_file, IdentifierType p_identifier_type)
            throws java.io.IOException
    {
        for (int i = 0; i < p_rules.via_infos.count(); ++i)
        {
            org.thehellnet.tools.freerouting.rules.ViaInfo curr_via = p_rules.via_infos.get(i);
            p_file.start_scope();
            p_file.write("via ");
            p_file.new_line();
    ...
    public static void write_via_rules(org.thehellnet.tools.freerouting.rules.BoardRules p_rules, IndentFileWriter p_file, IdentifierType p_identifier_type)
            throws java.io.IOException
    {
        for (org.thehellnet.tools.freerouting.rules.ViaRule curr_rule : p_rules.via_rules)
        {
            p_file.start_scope();
    ...
    public static void write_net_class(org.thehellnet.tools.freerouting.rules.NetClass p_net_class, WriteScopeParameter p_par)
            throws java.io.IOException
    {
        p_par.file.start_scope();
        ...
        // write the org.thehellnet.tools.freerouting.rules, if they are different from the default rule.
    ...
    private static void write_circuit(org.thehellnet.tools.freerouting.rules.NetClass p_net_class, WriteScopeParameter p_par)
            throws java.io.IOException
    {
            ...
            CoordinateTransform p_coordinate_transform, LayerStructure p_layer_structure, java.util.Locale p_locale)
    {
        ...
        for (Collection<Net.Pin> curr_pin_list : subnet_pin_lists)
        {
            ...
            {
                // Evaluate the net org.thehellnet.tools.freerouting.rules.
                org.thehellnet.tools.freerouting.rules.Net board_net = p_board.rules.nets.get(curr_subnet.id.name, curr_subnet.id.subnet_number);
                if (board_net == null)
                {
                    System.out.println("Network.read_net_scope: org.thehellnet.tools.freerouting.board net not found");
                    return false;
                }
                ...
                while (it.hasNext())
                {
                    ...
                    {
                        org.thehellnet.tools.freerouting.rules.NetClass default_net_rule = p_board.rules.get_default_net_class();
                        ...
                        org.thehellnet.tools.freerouting.rules.NetClass net_rule =
    ...
    static org.thehellnet.tools.freerouting.rules.ViaInfo read_via_info(Scanner p_scanner, org.thehellnet.tools.freerouting.board.BasicBoard p_board)
    {
        try
        {
            p_scanner.yybegin(SpecctraFileScanner.NAME);
            ...
            org.thehellnet.tools.freerouting.library.Padstack via_padstack = p_board.library.get_via_padstack(padstack_name);
            ...
            return new org.thehellnet.tools.freerouting.rules.ViaInfo(name, via_padstack, clearance_class, attach_allowed, p_board.rules);
        } catch (java.io.IOException e)
        {
    ...
    static Collection<String> read_via_rule(Scanner p_scanner, org.thehellnet.tools.freerouting.board.BasicBoard p_board)
    {
        try
        {
    ...
    private static void insert_via_infos(Collection<org.thehellnet.tools.freerouting.rules.ViaInfo> p_via_infos, RoutingBoard p_board, boolean p_attach_allowed)
    {
        if (p_via_infos.size() > 0)
        {
            for (org.thehellnet.tools.freerouting.rules.ViaInfo curr_info : p_via_infos)
            {
    ...
    private static void create_default_via_infos(org.thehellnet.tools.freerouting.board.BasicBoard p_board, org.thehellnet.tools.freerouting.rules.NetClass p_net_class, boolean p_attach_allowed)
    {
        int cl_class = p_net_class.default_item_clearance_classes.get(org.thehellnet.tools.freerouting.rules.DefaultItemClearanceClasses.ItemClass.VIA);
        ...
        {
            org.thehellnet.tools.freerouting.library.Padstack curr_padstack = p_board.library.get_via_padstack(i);
            ...
            org.thehellnet.tools.freerouting.rules.ViaInfo found_via_info =
                    new org.thehellnet.tools.freerouting.rules.ViaInfo(via_name, curr_padstack, cl_class, attach_allowed, p_board.rules);
            p_board.rules.via_infos.add(found_via_info);
        }
    }

    private static void insert_via_rules(Collection<Collection<String>> p_via_rules, org.thehellnet.tools.freerouting.board.BasicBoard p_board)
    {
    ...
    /**
     * Inserts a via rule into the org.thehellnet.tools.freerouting.board.
     * Replaces an already existing via rule with the same
     */
    static boolean add_via_rule(Collection<String> p_name_list, org.thehellnet.tools.freerouting.board.BasicBoard p_board)
    {
        Iterator<String> it = p_name_list.iterator();
        String rule_name = it.next();
        org.thehellnet.tools.freerouting.rules.ViaRule existing_rule = p_board.rules.get_via_rule(rule_name);
        org.thehellnet.tools.freerouting.rules.ViaRule curr_rule = new org.thehellnet.tools.freerouting.rules.ViaRule(rule_name);
        boolean rule_ok = true;
        while (it.hasNext())
        {
            org.thehellnet.tools.freerouting.rules.ViaInfo curr_via = p_board.rules.via_infos.get(it.next());
            if (curr_via != null)
            {
    ...
    {
        org.thehellnet.tools.freerouting.board.BasicBoard routing_board = p_par.board_handling.get_routing_board();
    ...
    static void insert_net_class(NetClass p_class, LayerStructure p_layer_structure, org.thehellnet.tools.freerouting.board.BasicBoard p_board, CoordinateTransform p_coordinate_transform,
                                 boolean p_via_at_smd_allowed)
    {
        org.thehellnet.tools.freerouting.rules.NetClass board_net_class = p_board.rules.append_net_class(p_class.name);
        ...
        {
            org.thehellnet.tools.freerouting.rules.ViaRule via_rule = p_board.rules.get_via_rule(p_class.via_rule);
            if (via_rule != null)
            {
        ...
        {
            Collection<org.thehellnet.tools.freerouting.rules.Net> curr_net_list = p_board.rules.nets.get(curr_net_name);
            for (org.thehellnet.tools.freerouting.rules.Net curr_net : curr_net_list)
            {
                curr_net.set_class(board_net_class);
            }
        }

        // read  the trace width  and clearance org.thehellnet.tools.freerouting.rules.
        ...
        // read the layer dependent org.thehellnet.tools.freerouting.rules.
    ...
    static private void insert_class_pairs(Collection<NetClass.ClassClass> p_class_classes, ReadScopeParameter p_par)
    {
        for (NetClass.ClassClass curr_class_class : p_class_classes)
        {
            ...
            while (it1.hasNext())
            {
                ...
                org.thehellnet.tools.freerouting.rules.NetClass first_class = routing_board.rules.net_classes.get(first_name);
                if (first_class == null)
                {
                ...
                else
                {
                    ...
                    while (it2.hasNext())
                    {
                        ...
                        org.thehellnet.tools.freerouting.rules.NetClass second_class = routing_board.rules.net_classes.get(second_name);
    ...
    static private void insert_class_pair_info(NetClass.ClassClass p_class_class, org.thehellnet.tools.freerouting.rules.NetClass p_first_class, org.thehellnet.tools.freerouting.rules.NetClass p_second_class,
                                               org.thehellnet.tools.freerouting.board.BasicBoard p_board, CoordinateTransform p_coordinate_transform)
    {
    ...
    static private void add_mixed_clearance_rule(org.thehellnet.tools.freerouting.rules.ClearanceMatrix p_clearance_matrix, org.thehellnet.tools.freerouting.rules.NetClass p_first_class,
                                                 org.thehellnet.tools.freerouting.rules.NetClass p_second_class, Rule.ClearanceRule p_clearance_rule, int p_layer_no,
    ...
    static private void create_default_clearance_classes(org.thehellnet.tools.freerouting.rules.NetClass p_net_class,
                                                         org.thehellnet.tools.freerouting.rules.ClearanceMatrix p_clearance_matrix)
    {
    ...
    private static void create_via_rule(Collection<String> p_use_via, org.thehellnet.tools.freerouting.rules.NetClass p_net_class, org.thehellnet.tools.freerouting.board.BasicBoard p_board, boolean p_attach_allowed)
    {
        org.thehellnet.tools.freerouting.rules.ViaRule new_via_rule = new org.thehellnet.tools.freerouting.rules.ViaRule(p_net_class.get_name());
        int default_via_cl_class = p_net_class.default_item_clearance_classes.get(org.thehellnet.tools.freerouting.rules.DefaultItemClearanceClasses.ItemClass.VIA);
        for (String curr_via_name : p_use_via)
        {
            for (int i = 0; i < p_board.rules.via_infos.count(); ++i)
            {
                org.thehellnet.tools.freerouting.rules.ViaInfo curr_via_info = p_board.rules.via_infos.get(i);
    ...
    private static void create_active_trace_layers(Collection<String> p_use_layer, LayerStructure p_layer_structure, org.thehellnet.tools.freerouting.rules.NetClass p_net_class)
    {
    ...
    private static void add_clearance_rule(org.thehellnet.tools.freerouting.rules.ClearanceMatrix p_clearance_matrix, org.thehellnet.tools.freerouting.rules.NetClass p_net_class,
     ...
     */
    static private int get_clearance_class(org.thehellnet.tools.freerouting.rules.ClearanceMatrix p_clearance_matrix,
                                           org.thehellnet.tools.freerouting.rules.NetClass p_net_class, String p_item_class_name)
    {
    ...
    /**
     * Create  the part org.thehellnet.tools.freerouting.library on the org.thehellnet.tools.freerouting.board. Can be called after the components are inserted.
    ...
    private static boolean insert_logical_parts(ReadScopeParameter p_par)
    {
        ...
        {
            org.thehellnet.tools.freerouting.library.Package lib_package = search_lib_package(next_part.name, p_par.logical_part_mappings, routing_board);
            if (lib_package == null)
            {
                return false;
            }
            org.thehellnet.tools.freerouting.library.LogicalPart.PartPin[] board_part_pins =
                    new org.thehellnet.tools.freerouting.library.LogicalPart.PartPin[next_part.part_pins.size()];
            int curr_index = 0;
            for (PartLibrary.PartPin curr_part_pin : next_part.part_pins)
            {
                ...
                board_part_pins[curr_index] =
                        new org.thehellnet.tools.freerouting.library.LogicalPart.PartPin(pin_no, curr_part_pin.pin_name,
        ...
        {
            org.thehellnet.tools.freerouting.library.LogicalPart curr_logical_part = routing_board.library.logical_parts.get(next_mapping.name);
            {
            ...
            {
                org.thehellnet.tools.freerouting.board.Component curr_component = routing_board.components.get(curr_cmp_name);
                ...
                {
                    System.out.println("Network.insert_logical_parts: org.thehellnet.tools.freerouting.board component not found");
                }
            }
        }
        return true;
    ...
    /**
     * Calculates the org.thehellnet.tools.freerouting.library package belonging to the logical part with name p_part_name.
     * Returns null, if the package was not found.
     */
    private static org.thehellnet.tools.freerouting.library.Package search_lib_package(String p_part_name,
                                                                                       java.util.Collection<PartLibrary.LogicalPartMapping> p_logical_part_mappings, org.thehellnet.tools.freerouting.board.BasicBoard p_board)
    {
        for (PartLibrary.LogicalPartMapping curr_mapping : p_logical_part_mappings)
        {
            if (curr_mapping.name.equals(p_part_name))
            {
                ...
                org.thehellnet.tools.freerouting.board.Component curr_component = p_board.components.get(component_name);
                if (curr_component == null)
                {
        ...
        System.out.print("Network.search_lib_package: org.thehellnet.tools.freerouting.library package ");
    ...
    /**
     * Inserts all org.thehellnet.tools.freerouting.board components belonging to the input org.thehellnet.tools.freerouting.library component.
     */
    ...
    {
        org.thehellnet.tools.freerouting.board.RoutingBoard routing_board = p_par.board_handling.get_routing_board();
        org.thehellnet.tools.freerouting.library.Package curr_front_package = routing_board.library.packages.get(p_lib_key, true);
        org.thehellnet.tools.freerouting.library.Package curr_back_package = routing_board.library.packages.get(p_lib_key, false);
        ...
        org.thehellnet.tools.freerouting.board.Component new_component = routing_board.components.add(p_location.name, component_location,
        ...
        org.thehellnet.tools.freerouting.board.FixedState fixed_state;
        if (p_location.position_fixed)
        {
            fixed_state = org.thehellnet.tools.freerouting.board.FixedState.SYSTEM_FIXED;
        }
        else
        {
            fixed_state = org.thehellnet.tools.freerouting.board.FixedState.UNFIXED;
        }
        org.thehellnet.tools.freerouting.library.Package curr_package = new_component.get_package();
        for (int i = 0; i < curr_package.pin_count(); ++i)
        {
            org.thehellnet.tools.freerouting.library.Package.Pin curr_pin = curr_package.get_pin(i);
            org.thehellnet.tools.freerouting.library.Padstack curr_padstack = routing_board.library.padstacks.get(curr_pin.padstack_no);
            ...
            {
                org.thehellnet.tools.freerouting.rules.Net curr_board_net = routing_board.rules.nets.get(curr_pin_net.id.name, curr_pin_net.id.subnet_number);
                if (curr_board_net == null)
                {
                    System.out.println("Network.insert_component: org.thehellnet.tools.freerouting.board net not found");
            ...
            org.thehellnet.tools.freerouting.rules.NetClass net_class;
            org.thehellnet.tools.freerouting.rules.Net board_net;
            ...
            if (clearance_class < 0)
            {
                ...
                {
                    clearance_class = net_class.default_item_clearance_classes.get(org.thehellnet.tools.freerouting.rules.DefaultItemClearanceClasses.ItemClass.SMD);
                }
                else
                {
                    clearance_class = net_class.default_item_clearance_classes.get(org.thehellnet.tools.freerouting.rules.DefaultItemClearanceClasses.ItemClass.PIN);
                }
            }
        ...
        for (int k = 0; k <= 2; ++k)
        {
            org.thehellnet.tools.freerouting.library.Package.Keepout[] keepout_arr;
            ...
            {
                org.thehellnet.tools.freerouting.library.Package.Keepout curr_keepout = keepout_arr[i];
                ...
                int clearance_class =
                        routing_board.rules.get_default_net_class().default_item_clearance_classes.get(org.thehellnet.tools.freerouting.rules.DefaultItemClearanceClasses.ItemClass.AREA);
