...
public class ReadScopeParameter
{
    ...
    ReadScopeParameter(Scanner p_scanner, org.thehellnet.tools.freerouting.interactive.BoardHandling p_board_handling,
                       org.thehellnet.tools.freerouting.board.BoardObservers p_observers,
                       org.thehellnet.tools.freerouting.datastructures.IdNoGenerator p_item_id_no_generator, org.thehellnet.tools.freerouting.board.TestLevel p_test_level)
    {
        scanner = p_scanner;
    ...
    final org.thehellnet.tools.freerouting.interactive.BoardHandling board_handling;
    final NetList netlist = new NetList();
    
    final org.thehellnet.tools.freerouting.board.BoardObservers  observers;
    final org.thehellnet.tools.freerouting.datastructures.IdNoGenerator item_id_no_generator;
    final org.thehellnet.tools.freerouting.board.TestLevel test_level;
     ...
     * evaluated after reading the org.thehellnet.tools.freerouting.library and network scope.
     */
     ...
     * and evaluated after reading the org.thehellnet.tools.freerouting.library scope.
     */
    Collection<String> via_padstack_names = null;
    
    boolean via_at_smd_allowed = false;
    org.thehellnet.tools.freerouting.board.AngleRestriction snap_angle = org.thehellnet.tools.freerouting.board.AngleRestriction.FORTYFIVE_DEGREE;
    ...
    org.thehellnet.tools.freerouting.board.Communication.SpecctraParserInfo.WriteResolution write_resolution = null;
    ...
    org.thehellnet.tools.freerouting.interactive.AutorouteSettings autoroute_settings = null;
    
    org.thehellnet.tools.freerouting.board.Unit unit = org.thehellnet.tools.freerouting.board.Unit.MIL;
