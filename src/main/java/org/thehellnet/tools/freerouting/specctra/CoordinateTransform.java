...
/**
 * Computes transformations between a specctra dsn-file coordinates and org.thehellnet.tools.freerouting.board coordinates.
 *
 * @author  Alfons Wirtz
 */
public class CoordinateTransform implements java.io.Serializable
{
     ...
     * The base point of the dsn coordinate system will be translated to zero in the org.thehellnet.tools.freerouting.board
     * coordinate system.
     */
    ...
    /**
     * Scale a value from the org.thehellnet.tools.freerouting.board to the dsn coordinate system
     */
    ...
    /**
     * Scale a value from the dsn to the org.thehellnet.tools.freerouting.board coordinate system
     */
    ...
    /**
     * Transforms a org.thehellnet.tools.freerouting.planar.FloatPoint to a tuple of doubles
    ...
    /**
     * Transforms an array of n org.thehellnet.tools.freerouting.planar.FloatPoints to
    ...
    /**
     * Transforms an array of n org.thehellnet.tools.freerouting.planar.Lines to
    ...
    /**
     * Transforms a org.thehellnet.tools.freerouting.planar.Vector to a tuple of doubles
     * in the dsn coordinate system.
     */
    ...
    /**
     * Transforms a dsn tuple to a org.thehellnet.tools.freerouting.planar.FloatPoint
     */
    ...
    /**
     * Transforms a dsn tuple to a org.thehellnet.tools.freerouting.planar.FloatPoint in relative (vector) coordinates.
     */
    ...
    /**
     * Transforms a org.thehellnet.tools.freerouting.planar.Intbox to the coordinates of a Rectangle.
     */
    ...
    /**
     * Transforms a org.thehellnet.tools.freerouting.planar.Intbox to a Rectangle in relative (vector) coordinates.
     */
    ...
    /**
     * Transforms a org.thehellnet.tools.freerouting.board shape to a dsn shape.
     */
    public Shape board_to_dsn(org.thehellnet.tools.freerouting.planar.Shape p_board_shape, Layer p_layer)
    {
        Shape result;
        ...
        else if (p_board_shape instanceof org.thehellnet.tools.freerouting.planar.Circle)
        {
            org.thehellnet.tools.freerouting.planar.Circle board_circle = (org.thehellnet.tools.freerouting.planar.Circle) p_board_shape;
    ...
    /**
     * Transforms the relative (vector) coordinates of a org.thehellnet.tools.freerouting.planar.Shape to a specctra dsn shape.
     */
    public Shape board_to_dsn_rel(org.thehellnet.tools.freerouting.planar.Shape p_board_shape, Layer p_layer)
    {
        Shape result;
        if (p_board_shape instanceof IntBox)
        {
