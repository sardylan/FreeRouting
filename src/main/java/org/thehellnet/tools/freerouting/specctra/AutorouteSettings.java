...
public class AutorouteSettings
{
    ...
    static org.thehellnet.tools.freerouting.interactive.AutorouteSettings read_scope(Scanner p_scanner, LayerStructure p_layer_structure)
    {
        org.thehellnet.tools.freerouting.interactive.AutorouteSettings result = new org.thehellnet.tools.freerouting.interactive.AutorouteSettings(p_layer_structure.arr.length);
    ...
    static org.thehellnet.tools.freerouting.interactive.AutorouteSettings read_layer_rule(Scanner p_scanner, LayerStructure p_layer_structure,
                                                                                          org.thehellnet.tools.freerouting.interactive.AutorouteSettings p_settings)
    {
    ...
    static void write_scope(IndentFileWriter p_file, org.thehellnet.tools.freerouting.interactive.AutorouteSettings p_settings,
                            org.thehellnet.tools.freerouting.board.LayerStructure p_layer_structure, IdentifierType p_identifier_type) throws java.io.IOException
    {
        p_file.start_scope();
        ...
        p_file.new_line();
        p_file.write("(org.thehellnet.tools.freerouting.autoroute ");
        ...
        {
            org.thehellnet.tools.freerouting.board.Layer curr_layer = p_layer_structure.arr[i];
            p_file.start_scope();
