...
public class Resolution extends ScopeKeyword
{
    ...
    public boolean read_scope(ReadScopeParameter p_par)
    {
        try
        {
            ...
            p_par.unit = org.thehellnet.tools.freerouting.board.Unit.from_string((String) next_token);
            if (p_par.unit == null)
            {
    ...
    public static void write_scope(org.thehellnet.tools.freerouting.datastructures.IndentFileWriter p_file, org.thehellnet.tools.freerouting.board.Communication p_board_communication)  throws java.io.IOException
    {
        p_file.new_line();
