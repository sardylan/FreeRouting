...
import org.thehellnet.tools.freerouting.board.Communication.SpecctraParserInfo;
...
public class Parser extends ScopeKeyword
{
     ...
     */
    public static void write_scope(org.thehellnet.tools.freerouting.datastructures.IndentFileWriter p_file, SpecctraParserInfo p_parser_info,
                                   org.thehellnet.tools.freerouting.datastructures.IdentifierType p_identifier_type, boolean p_reduced) throws java.io.IOException
    {
        p_file.start_scope();
        p_file.write("parser");
        if (!p_reduced)
