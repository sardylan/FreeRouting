...
public class SessionToEagle extends javax.swing.JFrame
{
    ...
    public static boolean get_instance(java.io.InputStream p_session, java.io.OutputStream p_output_stream,
            org.thehellnet.tools.freerouting.board.BasicBoard p_board)
    {
    ...
    SessionToEagle(Scanner p_scanner, java.io.OutputStreamWriter p_out_file, org.thehellnet.tools.freerouting.board.BasicBoard p_board,
                   org.thehellnet.tools.freerouting.board.Unit p_unit, double p_session_file_scale_dominator, double p_board_scale_factor)
    {
        scanner = p_scanner;
        out_file = p_out_file;
        board = p_board;
    ...
    private boolean process_session_scope() throws java.io.IOException
    {
        ...
        org.thehellnet.tools.freerouting.planar.IntBox board_bounding_box = this.board.get_bounding_box();
    ...
    private boolean process_via_scope(String p_net_name) throws java.io.IOException
    {
        ...
        org.thehellnet.tools.freerouting.library.Padstack via_padstack = this.board.library.padstacks.get(padstack_name);
        ...
        org.thehellnet.tools.freerouting.planar.ConvexShape via_shape = via_padstack.get_shape(via_padstack.from_layer());
        ...
        if (via_shape instanceof org.thehellnet.tools.freerouting.planar.Circle)
        {
            this.out_file.write(" round ");
        }
        else if (via_shape instanceof org.thehellnet.tools.freerouting.planar.IntOctagon)
        {
    ...
    {
        java.util.Collection<org.thehellnet.tools.freerouting.board.Pin> component_pins = this.board.get_component_pins(p_component_no);
        boolean component_has_swapped_pins = false;
        for (org.thehellnet.tools.freerouting.board.Pin curr_pin : component_pins)
        {
    ...
    private void write_pin_swap(org.thehellnet.tools.freerouting.board.Pin p_pin_1, org.thehellnet.tools.freerouting.board.Pin p_pin_2) throws java.io.IOException
    {
    ...
    /** Some information is read from the org.thehellnet.tools.freerouting.board, because it is not contained in the speccctra session file. */
    private final org.thehellnet.tools.freerouting.board.BasicBoard board;
    
    /** The layer structure in specctra format */
    private final LayerStructure specctra_layer_structure;
    
    private final org.thehellnet.tools.freerouting.board.Unit unit;
    ...
    /** The scale factor for transforming coordinates from the org.thehellnet.tools.freerouting.board to Eagle */
    private final double board_scale_factor;
    
    private static class PinInfo
    {
        PinInfo(org.thehellnet.tools.freerouting.board.Pin p_pin)
        {
            pin = p_pin;
            curr_changed_to = p_pin;
        }
        final org.thehellnet.tools.freerouting.board.Pin pin;
        org.thehellnet.tools.freerouting.board.Pin curr_changed_to;
    }
}
