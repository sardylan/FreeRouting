...
import org.thehellnet.tools.freerouting.planar.TileShape;
...
import org.thehellnet.tools.freerouting.datastructures.UndoableObjects.Storable;
...
class Structure extends ScopeKeyword
{
    ...
    public boolean read_scope(ReadScopeParameter p_par)
    {
        ...
        for (;;)
        {
            ...
            if (prev_token == OPEN_BRACKET)
            {
                ...
                else if (next_token == Keyword.SNAP_ANGLE)
                {
                    ...
                    org.thehellnet.tools.freerouting.board.AngleRestriction snap_angle = read_snap_angle(p_par.scanner);
                    if (snap_angle != null)
                    {
        ...
        org.thehellnet.tools.freerouting.board.RoutingBoard board = p_par.board_handling.get_routing_board();
        if (board == null)
        {
            return false;
        }
        ...
        while (it.hasNext())
        {
            ...
            org.thehellnet.tools.freerouting.rules.Net curr_net = board.rules.nets.get(plane_info.net_name, 1);
            if (curr_net == null)
            {
                System.out.println("Plane.read_scope: net not found");
                continue;
            }
            org.thehellnet.tools.freerouting.planar.Area plane_area =
            ...
            if (curr_layer.no >= 0)
            {
                ...
                {
                    clearance_class_no = curr_net.get_class().default_item_clearance_classes.get(org.thehellnet.tools.freerouting.rules.DefaultItemClearanceClasses.ItemClass.AREA);
                }
    ...
    public static void write_scope(WriteScopeParameter p_par) throws java.io.IOException
    {
        ...
        // lookup the outline in the org.thehellnet.tools.freerouting.board
        ...
        for (;;)
        {
            ...
            if (curr_ob instanceof org.thehellnet.tools.freerouting.board.BoardOutline)
            {
                break;
            }
        }
        ...
        org.thehellnet.tools.freerouting.board.BoardOutline outline = (org.thehellnet.tools.freerouting.board.BoardOutline) curr_ob;
        ...
        // write the org.thehellnet.tools.freerouting.autoroute settings
        ...
        for (;;)
        {
            ...
            if (!(curr_ob instanceof org.thehellnet.tools.freerouting.board.ObstacleArea))
            {
                continue;
            }
            org.thehellnet.tools.freerouting.board.ObstacleArea curr_keepout = (org.thehellnet.tools.freerouting.board.ObstacleArea) curr_ob;
            if (curr_keepout.get_component_no() != 0)
            {
                // keepouts belonging to a component are not written individually.
                continue;
            }
            if (curr_keepout instanceof org.thehellnet.tools.freerouting.board.ConductionArea)
            {
        ...
        for (;;)
        {
            ...
            if (!(curr_ob instanceof org.thehellnet.tools.freerouting.board.ConductionArea))
            {
                continue;
            }
            org.thehellnet.tools.freerouting.board.ConductionArea curr_area = (org.thehellnet.tools.freerouting.board.ConductionArea) curr_ob;
            if (p_par.board.layer_structure.arr[curr_area.get_layer()].is_signal)
            {
                // These conduction areas are written in the wiring scope.
                continue;
            }
            Plane.write_scope(p_par, (org.thehellnet.tools.freerouting.board.ConductionArea) curr_ob);
        }
        p_par.file.end_scope();
    }
    ...
    private static void write_via_padstacks(org.thehellnet.tools.freerouting.library.BoardLibrary p_library, IndentFileWriter p_file,
                                            IdentifierType p_identifier_type) throws java.io.IOException
    {
        ...
        {
            org.thehellnet.tools.freerouting.library.Padstack curr_padstack = p_library.get_via_padstack(i);
    ...
    private static void write_control_scope(org.thehellnet.tools.freerouting.rules.BoardRules p_rules, IndentFileWriter p_file) throws java.io.IOException
    {
        p_file.start_scope();
    ...
    private static void write_keepout_scope(WriteScopeParameter p_par, org.thehellnet.tools.freerouting.board.ObstacleArea p_keepout) throws java.io.IOException
    {
        org.thehellnet.tools.freerouting.planar.Area keepout_area = p_keepout.get_area();
        int layer_no = p_keepout.get_layer();
        org.thehellnet.tools.freerouting.board.Layer board_layer = p_par.board.layer_structure.arr[layer_no];
        Layer keepout_layer = new Layer(board_layer.name, layer_no, board_layer.is_signal);
        org.thehellnet.tools.freerouting.planar.Shape boundary_shape;
        org.thehellnet.tools.freerouting.planar.Shape[] holes;
        if (keepout_area instanceof org.thehellnet.tools.freerouting.planar.Shape)
        {
            boundary_shape = (org.thehellnet.tools.freerouting.planar.Shape) keepout_area;
            holes = new org.thehellnet.tools.freerouting.planar.Shape[0];
        }
        else
        {
        ...
        p_par.file.start_scope();
        if (p_keepout instanceof org.thehellnet.tools.freerouting.board.ViaObstacleArea)
        {
    ...
    static org.thehellnet.tools.freerouting.board.AngleRestriction read_snap_angle(Scanner p_scanner)
    {
        try
        {
            Object next_token = p_scanner.next_token();
            org.thehellnet.tools.freerouting.board.AngleRestriction snap_angle;
            if (next_token == Keyword.NINETY_DEGREE)
            {
                snap_angle = org.thehellnet.tools.freerouting.board.AngleRestriction.NINETY_DEGREE;
            }
            else if (next_token == Keyword.FORTYFIVE_DEGREE)
            {
                snap_angle = org.thehellnet.tools.freerouting.board.AngleRestriction.FORTYFIVE_DEGREE;
            }
            else if (next_token == Keyword.NONE)
            {
                snap_angle = org.thehellnet.tools.freerouting.board.AngleRestriction.NONE;
            }
            else
            {
    ...
    static void write_snap_angle(IndentFileWriter p_file, org.thehellnet.tools.freerouting.board.AngleRestriction p_angle_restriction) throws java.io.IOException
    {
        p_file.start_scope();
        p_file.write("snap_angle ");
        p_file.new_line();

        if (p_angle_restriction == org.thehellnet.tools.freerouting.board.AngleRestriction.NINETY_DEGREE)
        {
            p_file.write("ninety_degree");
        }
        else if (p_angle_restriction == org.thehellnet.tools.freerouting.board.AngleRestriction.FORTYFIVE_DEGREE)
        {
    ...
    private boolean create_board(ReadScopeParameter p_par, BoardConstructionInfo p_board_construction_info)
    {
        ...
        org.thehellnet.tools.freerouting.board.Layer[] board_layer_arr = new org.thehellnet.tools.freerouting.board.Layer[layer_count];
        ...
        for (int i = 0; i < layer_count; ++i)
        {
            ...
            board_layer_arr[i] = new org.thehellnet.tools.freerouting.board.Layer(curr_layer.name, curr_layer.is_signal);
        }
        org.thehellnet.tools.freerouting.board.LayerStructure board_layer_structure = new org.thehellnet.tools.freerouting.board.LayerStructure(board_layer_arr);
        p_par.layer_structure = new LayerStructure(p_board_construction_info.layer_info);

        // Calculate an appropritate scaling between dsn coordinates and org.thehellnet.tools.freerouting.board coordinates.
        ...
        while (5 * max_coor >= org.thehellnet.tools.freerouting.planar.Limits.CRIT_INT)
        {
            scale_factor /= 10;
            max_coor /= 10;
        }
        ...
        org.thehellnet.tools.freerouting.rules.ClearanceMatrix clearance_matrix = org.thehellnet.tools.freerouting.rules.ClearanceMatrix.get_default_instance(board_layer_structure, 0);
        org.thehellnet.tools.freerouting.rules.BoardRules board_rules = new org.thehellnet.tools.freerouting.rules.BoardRules(board_layer_structure, clearance_matrix);
        org.thehellnet.tools.freerouting.board.Communication.SpecctraParserInfo specctra_parser_info =
                new org.thehellnet.tools.freerouting.board.Communication.SpecctraParserInfo(p_par.string_quote, p_par.host_cad,
                p_par.host_version, p_par.constants, p_par.write_resolution, p_par.dsn_file_generated_by_host);
        org.thehellnet.tools.freerouting.board.Communication board_communication =
                new org.thehellnet.tools.freerouting.board.Communication(p_par.unit, p_par.resolution, specctra_parser_info,
        ...
        org.thehellnet.tools.freerouting.board.BasicBoard board = p_par.board_handling.get_routing_board();

        // Insert the holes in the org.thehellnet.tools.freerouting.board outline as keepouts.
    ...
    private static void insert_missing_power_planes(Collection<Layer> p_layer_info,
            NetList p_netlist, org.thehellnet.tools.freerouting.board.BasicBoard p_board)
    {
        Collection<org.thehellnet.tools.freerouting.board.ConductionArea> conduction_areas = p_board.get_conduction_areas();
        for (Layer curr_layer : p_layer_info)
        {
            ...
            for (org.thehellnet.tools.freerouting.board.ConductionArea curr_conduction_area : conduction_areas)
            {
            ...
            if (!conduction_area_found && !curr_layer.net_names.isEmpty())
            {
                ...
                org.thehellnet.tools.freerouting.rules.Net curr_net = p_board.rules.nets.get(curr_net_id.name, curr_net_id.subnet_number);
                {
                    if (curr_net == null)
                    {
    ...
    /**
     * Updates the org.thehellnet.tools.freerouting.board org.thehellnet.tools.freerouting.rules from the org.thehellnet.tools.freerouting.rules read from the dsn file.
     */
            ...
            BoardConstructionInfo p_board_construction_info, BoardRules p_board_rules)
    {
        ...
        // update width org.thehellnet.tools.freerouting.rules
    ...
    /**
     * Converts a dsn clearance rule into a org.thehellnet.tools.freerouting.board clearance rule.
    ...
    static private int append_clearance_class(BoardRules p_board_rules, String p_name)
    {
        ...
        org.thehellnet.tools.freerouting.rules.NetClass default_net_class = p_board_rules.get_default_net_class();
     ...
     */
    private static boolean clearance_equals(org.thehellnet.tools.freerouting.rules.ClearanceMatrix p_cl_matrix, int p_layer_1, int p_layer_2)
    {
    ...
    {
        org.thehellnet.tools.freerouting.planar.Area keepout_area =
        ...
        if (board == null)
        {
            System.out.println("Structure.insert_keepout: org.thehellnet.tools.freerouting.board not initialized");
            return false;
        }
    ...
    private static void insert_keepout(org.thehellnet.tools.freerouting.board.BasicBoard p_board, org.thehellnet.tools.freerouting.planar.Area p_area, int p_layer,
                                       String p_clearance_class_name, KeepoutType p_keepout_type, FixedState p_fixed_state)
    {
        ...
        {
            clearance_class_no =
                    p_board.rules.get_default_net_class().default_item_clearance_classes.get(org.thehellnet.tools.freerouting.rules.DefaultItemClearanceClasses.ItemClass.AREA);
        }
        else
        {
