...
public class Net
{
    ...
    public static void write_scope(WriteScopeParameter p_par, org.thehellnet.tools.freerouting.rules.Net p_net, Collection<org.thehellnet.tools.freerouting.board.Pin> p_pin_list) throws java.io.IOException
    {
        ...
        Iterator<org.thehellnet.tools.freerouting.board.Pin> it = p_pin_list.iterator();
        while (it.hasNext())
        {
            org.thehellnet.tools.freerouting.board.Pin curr_pin = it.next();
    ...
    public static void write_net_id(org.thehellnet.tools.freerouting.rules.Net p_net, IndentFileWriter p_file, IdentifierType p_identifier_type) throws java.io.IOException
    {
        p_file.write("net ");
    ...
    public static void write_pin(WriteScopeParameter p_par, org.thehellnet.tools.freerouting.board.Pin p_pin) throws java.io.IOException
    {
        org.thehellnet.tools.freerouting.board.Component curr_component = p_par.board.components.get(p_pin.get_component_no());
        if (curr_component == null)
        {
            System.out.println("Net.write_scope: component not found");
            return;
        }
        org.thehellnet.tools.freerouting.library.Package.Pin lib_pin = curr_component.get_package().get_pin(p_pin.get_index_in_package());
        if (lib_pin == null)
        {
