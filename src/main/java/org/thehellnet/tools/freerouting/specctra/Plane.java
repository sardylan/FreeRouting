...
public class Plane extends ScopeKeyword
{
    ...
    public static void write_scope(WriteScopeParameter p_par, org.thehellnet.tools.freerouting.board.ConductionArea p_conduction) throws java.io.IOException
    {
        ...
        org.thehellnet.tools.freerouting.planar.Area curr_area = p_conduction.get_area();
