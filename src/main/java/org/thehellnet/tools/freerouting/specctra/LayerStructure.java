...
public class LayerStructure
{
    ...
    /**
     * Creates a dsn-LayerStructure from a org.thehellnet.tools.freerouting.board LayerStructure.
     */
    public LayerStructure(org.thehellnet.tools.freerouting.board.LayerStructure p_board_layer_structure)
    {
        arr = new Layer[p_board_layer_structure.arr.length];
        for (int i = 0; i < arr.length; ++i)
        {
            org.thehellnet.tools.freerouting.board.Layer board_layer = p_board_layer_structure.arr[i];
