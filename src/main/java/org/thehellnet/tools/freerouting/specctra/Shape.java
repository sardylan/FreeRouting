...
public abstract class Shape
{
    ...
    /**
     * Transforms a shape with holes to the org.thehellnet.tools.freerouting.board coordinate system.
     * The first shape in the Collection p_area is the border,
     * the other shapes are holes of the area.
     */
    public static org.thehellnet.tools.freerouting.planar.Area transform_area_to_board(Collection<Shape> p_area, CoordinateTransform p_coordinate_transform)
    {
        ...
        org.thehellnet.tools.freerouting.planar.Shape boundary_shape = boundary.transform_to_board(p_coordinate_transform);
        org.thehellnet.tools.freerouting.planar.Area result;
        if (hole_count == 0)
        {
        ...
        {
            // Area with holes
            if (!(boundary_shape instanceof org.thehellnet.tools.freerouting.planar.PolylineShape))
            {
            ...
            {
                org.thehellnet.tools.freerouting.planar.Shape hole_shape = it.next().transform_to_board(p_coordinate_transform);
            ...
            result = new org.thehellnet.tools.freerouting.planar.PolylineArea(border, holes);
        }
        return result;
    }

    /**
     * Transforms the relative coordinates of a shape with holes to the org.thehellnet.tools.freerouting.board coordinate system.
     * The first shape in the Collection p_area is the border,
     * the other shapes are holes of the area.
     */
    public static org.thehellnet.tools.freerouting.planar.Area transform_area_to_board_rel(Collection<Shape> p_area, CoordinateTransform p_coordinate_transform)
    {
        int hole_count = p_area.size() - 1;
        if (hole_count <= -1)
        {
        ...
        Iterator<Shape> it = p_area.iterator();
        Shape boundary = it.next();
        org.thehellnet.tools.freerouting.planar.Shape boundary_shape = boundary.transform_to_board_rel(p_coordinate_transform);
        org.thehellnet.tools.freerouting.planar.Area result;
        if (hole_count == 0)
        {
            result = boundary_shape;
        ...
        else
        {
            ...
            for (int i = 0; i < holes.length; ++i)
            {
                org.thehellnet.tools.freerouting.planar.Shape hole_shape = it.next().transform_to_board_rel(p_coordinate_transform);
                if (!(hole_shape instanceof PolylineShape))
                {
                    System.out.println("Shape.transform_area_to_board: PolylineShape expected");
                    return null;
    ...
    /**
     * Transforms a specctra dsn shape to a org.thehellnet.tools.freerouting.planar.Shape.
     */
    public abstract org.thehellnet.tools.freerouting.planar.Shape transform_to_board(CoordinateTransform p_coordinate_transform);
    ...
    /**
     * Transforms the relative (vector) coordinates of a specctra dsn shape to a org.thehellnet.tools.freerouting.planar.Shape.
     */
    public abstract org.thehellnet.tools.freerouting.planar.Shape transform_to_board_rel(CoordinateTransform p_coordinate_transform);
