...
public interface CompleteExpansionRoom extends ExpansionRoom
{
     ...
     */
    org.thehellnet.tools.freerouting.board.SearchTreeObject get_object();
    
    /**
     * Draws the shape of this room for test purposes
     */
    void draw(java.awt.Graphics p_graphics, org.thehellnet.tools.freerouting.boardgraphics.GraphicsContext p_graphics_context, double p_intensity);
}
