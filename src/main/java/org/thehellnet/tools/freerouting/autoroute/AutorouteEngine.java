...
import org.thehellnet.tools.freerouting.board.ShapeSearchTree90Degree;
import org.thehellnet.tools.freerouting.board.ShapeSearchTree45Degree;
import org.thehellnet.tools.freerouting.board.TestLevel;

/**
 * Temporary org.thehellnet.tools.freerouting.autoroute data stored on the RoutingBoard.
 *
 * @author  Alfons Wirtz
 */
public class AutorouteEngine
{
            ...
            AutorouteControl p_ctrl, SortedSet<Item> p_ripped_item_list)
    {
        ...
        // let the observers know the changes in the org.thehellnet.tools.freerouting.board database.
     ...
     */
    public void draw(java.awt.Graphics p_graphics, org.thehellnet.tools.freerouting.boardgraphics.GraphicsContext p_graphics_context, double p_intensity)
    {
        if (complete_expansion_rooms == null)
        {
            return;
     ...
     * It depends on the trac clearance class used in the org.thehellnet.tools.freerouting.autoroute algorithm.
     */
    ...
    /**
     * The net number used for routing in this org.thehellnet.tools.freerouting.autoroute algorithm.
     */
    private int net_no;
    /**
    ...
    /** The PCB-org.thehellnet.tools.freerouting.board of this org.thehellnet.tools.freerouting.autoroute algorithm. */
    final RoutingBoard board;
    /** The list of incomplete expansion rooms on the routing org.thehellnet.tools.freerouting.board */
    private List<IncompleteFreeSpaceExpansionRoom> incomplete_expansion_rooms = null;
    /** The list of complete expansion rooms on the routing org.thehellnet.tools.freerouting.board */
