...
/**
 * Temporary data stored in org.thehellnet.tools.freerouting.board Items used in the org.thehellnet.tools.freerouting.autoroute algorithm
 *
 * @author  Alfons Wirtz
 */
...
public class ItemAutorouteInfo
{
    ...
    /**
     * Looks, if the corresponding item belongs to the start or destination set of the org.thehellnet.tools.freerouting.autoroute algorithm.
    ...
    /**
     * Sets, if the corresponding item belongs to the start or destination set of the org.thehellnet.tools.freerouting.autoroute algorithm.
     * Only used, if the item belongs to the net, which will be currently routed.
     */
