...
/**
 * Structure for controlling the org.thehellnet.tools.freerouting.autoroute algorithm.
 *
 * @author  Alfons Wirtz
 */
public class AutorouteControl
{
    ...
    public AutorouteControl(RoutingBoard p_board, int p_net_no, org.thehellnet.tools.freerouting.interactive.Settings p_settings)
    {
    ...
    /** Creates a new instance of AutorouteControl for the input net */
    public AutorouteControl(RoutingBoard p_board, int p_net_no, org.thehellnet.tools.freerouting.interactive.Settings p_settings, int p_via_costs, ExpansionCostFactor[] p_trace_cost_arr)
    {
    ...
    private AutorouteControl(RoutingBoard p_board, org.thehellnet.tools.freerouting.interactive.Settings p_settings,
    ...
    private void init_net(int p_net_no, RoutingBoard p_board, int p_via_costs)
    {
        ...
        org.thehellnet.tools.freerouting.rules.NetClass curr_net_class;
        if (curr_net != null)
        {
        ...
        for (int i = 0; i < via_rule.via_count(); ++i)
        {
            ...
            org.thehellnet.tools.freerouting.library.Padstack curr_via_padstack = curr_via.get_padstack();
    ...
    /** The currently used net number in the org.thehellnet.tools.freerouting.autoroute algorithm */
    int net_no;
    /** The currently used trace half widths in the org.thehellnet.tools.freerouting.autoroute algorithm on each layer */
    final int[] trace_half_width;
    /**
     * The currently used compensated trace half widths in the org.thehellnet.tools.freerouting.autoroute algorithm on each layer.
     * Equal to trace_half_width if no clearance compensation is used.
     */
    final int[] compensated_trace_half_width;
    /** The currently used clearance class for traces in the org.thehellnet.tools.freerouting.autoroute algorithm */
    public int trace_clearance_class_no;
    /** The currently used clearance class for vias in the org.thehellnet.tools.freerouting.autoroute algorithm */
    ...
    /** If true, the org.thehellnet.tools.freerouting.autoroute algorithm completes after the first drill */
    ...
    /** horizontal and vertical costs for traces on a org.thehellnet.tools.freerouting.board layer */
    public static class ExpansionCostFactor
    {
        ...
        /** The horizontal expansion cost factor on a layer of the org.thehellnet.tools.freerouting.board */
        public final double horizontal;
        /** The verical expansion cost factor on a layer of the org.thehellnet.tools.freerouting.board */
