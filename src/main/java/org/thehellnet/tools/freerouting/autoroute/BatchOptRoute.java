...
/**
 * To optimize the vias and traces after the batch autorouter has completed the org.thehellnet.tools.freerouting.board.
 * 
 * @author  Alfons Wirtz
 */
public class BatchOptRoute
{
    ...
    /**
     *  To optimize the route on the org.thehellnet.tools.freerouting.board after the org.thehellnet.tools.freerouting.autoroute task is finished.
     */
    ...
    /**
     * Optimize the route on the org.thehellnet.tools.freerouting.board.
     */
    ...
    /**
     * Pass to reduce the number of vias an to shorten the trace lengthon a completely routed org.thehellnet.tools.freerouting.board.
    ...
    private boolean opt_route_item(Item p_item, int p_pass_no, boolean p_with_prefered_directions)
    {
        java.util.ResourceBundle resources =
                java.util.ResourceBundle.getBundle("interactive/InteractiveState", this.thread.hdlg.get_locale());
     ...
     *  on the org.thehellnet.tools.freerouting.board, which are not shove_fixed.
     */
    private static double calc_weighted_trace_length(RoutingBoard p_board)
    {
        double result = 0;
        int default_clearance_class = org.thehellnet.tools.freerouting.rules.BoardRules.default_clearance_class();
    ...
    /**
     *  Reads the vias and traces on the org.thehellnet.tools.freerouting.board in ascending x order.
     *  Because the vias and traces on the org.thehellnet.tools.freerouting.board change while optimizing the item list
     *  of the org.thehellnet.tools.freerouting.board is read from scratch each time the next route item is returned.
     */
