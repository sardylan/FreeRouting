...
/**
 * Inserts the traces and vias of the connection found by the org.thehellnet.tools.freerouting.autoroute algorithm.
 *
 * @author  Alfons Wirtz
 */
public class InsertFoundConnectionAlgo
{
    ...
    private boolean insert_trace(LocateFoundConnectionAlgoAnyAngle.ResultItem p_trace)
    {
        ...
        org.thehellnet.tools.freerouting.board.Pin start_pin = null;
        org.thehellnet.tools.freerouting.board.Pin end_pin = null;
    ...
    boolean insert_neckdown(Point p_from_corner, Point p_to_corner, int p_layer, org.thehellnet.tools.freerouting.board.Pin p_start_pin, org.thehellnet.tools.freerouting.board.Pin p_end_pin)
    {
        if (p_start_pin != null)
        {
    ...
    private Point try_neck_down(Point p_from_corner, Point p_to_corner, int p_layer, org.thehellnet.tools.freerouting.board.Pin p_pin, boolean p_at_start)
    {
