...
/**
 * Expansion Room used for pushing and ripping obstacles in the org.thehellnet.tools.freerouting.autoroute algorithm.
 *
 * @author Alfons Wirtz
 */
public class ObstacleExpansionRoom implements CompleteExpansionRoom
{
    ...
    /**
     * Creates a 2-dim door with the other obstacle room, if that is useful for the org.thehellnet.tools.freerouting.autoroute algorithm.
