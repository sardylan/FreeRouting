...
/**
 * Describes org.thehellnet.tools.freerouting.board components consisting of an array of pins
...
public class Component implements UndoableObjects.Storable, ObjectInfoPanel.Printable, java.io.Serializable
{
    ...
    /**
     * If false, the component will be placed on the back side of the org.thehellnet.tools.freerouting.board.
     */
     ...
     * The Pins in the org.thehellnet.tools.freerouting.board must be moved seperately.
     */
    ...
    public void rotate(double p_angle_in_degree, IntPoint p_pole, boolean p_flip_style_rotate_first)
    {
        ...
        {
            // take care of the order of mirroring and rotating on the back side of the org.thehellnet.tools.freerouting.board
     ...
     */
    public org.thehellnet.tools.freerouting.library.LogicalPart get_logical_part()
    {
     ...
     */
    public void set_logical_part(org.thehellnet.tools.freerouting.library.LogicalPart p_logical_part)
    {
    ...
    /**
     * Returns the org.thehellnet.tools.freerouting.library package of this component.
     */
    ...
    /** The rotation of the org.thehellnet.tools.freerouting.library package of the component in degree */
    private double rotation_in_degree;
    
    /** Contains information for gate swapping and pin swapping, if != null */
    private org.thehellnet.tools.freerouting.library.LogicalPart logical_part = null;
    
    /** If false, the component will be placed on the back side of the org.thehellnet.tools.freerouting.board. */
    private boolean on_front;
    
    /** The org.thehellnet.tools.freerouting.library package of the component if it is placed on the component side. */
    private final Package lib_package_front;
    
    /** The org.thehellnet.tools.freerouting.library package of the component if it is placed on the solder side. */
