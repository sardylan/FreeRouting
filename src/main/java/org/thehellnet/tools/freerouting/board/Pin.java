...
import org.thehellnet.tools.freerouting.planar.Direction;
...
import org.thehellnet.tools.freerouting.library.Package;
import org.thehellnet.tools.freerouting.library.Padstack;

/**
 * Class describing the functionality of an electrical Item on the org.thehellnet.tools.freerouting.board
...
public class Pin extends DrillItem implements java.io.Serializable
{
    ...
    /**
     * Gets index of this pin in the org.thehellnet.tools.freerouting.library package of the pins component.
     */
    ...
    public java.util.Set<Pin> get_swappable_pins()
    {
        ...
        org.thehellnet.tools.freerouting.library.LogicalPart logical_part = component.get_logical_part();
        if (logical_part == null)
        {
            return result;
        }
        org.thehellnet.tools.freerouting.library.LogicalPart.PartPin this_part_pin = logical_part.get_pin(this.pin_no);
        ...
        for( int i = 0; i < logical_part.pin_count(); ++i)
        {
            ...
            org.thehellnet.tools.freerouting.library.LogicalPart.PartPin curr_part_pin =  logical_part.get_pin(i);
    ...
    public java.awt.Color[] get_draw_colors(org.thehellnet.tools.freerouting.boardgraphics.GraphicsContext p_graphics_context)
    {
    ...
    public double get_draw_intensity(org.thehellnet.tools.freerouting.boardgraphics.GraphicsContext p_graphics_context)
    {
    ...
    /** False, if this drillitem is places on the back side of the org.thehellnet.tools.freerouting.board */
    ...
    public double get_min_width(int p_layer)
    {
        ...
        org.thehellnet.tools.freerouting.planar.IntBox padstack_bounding_box = padstack_shape.bounding_box();
    ...
    public void print_info(ObjectInfoPanel p_window, java.util.Locale p_locale)
    {
        ...
        org.thehellnet.tools.freerouting.library.Padstack padstack = this.get_padstack();
