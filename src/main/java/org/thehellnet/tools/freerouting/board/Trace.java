...
public abstract class Trace extends Item implements Connectable, java.io.Serializable
{
    ...
    {
        return org.thehellnet.tools.freerouting.boardgraphics.Drawable.MAX_DRAW_PRIORITY;
    }
    ...
    public boolean is_shove_fixed()
    {
        ...
        org.thehellnet.tools.freerouting.rules.Nets nets = this.board.rules.nets;
        for (int curr_net_no : this.net_no_arr)
        {
            if (org.thehellnet.tools.freerouting.rules.Nets.is_normal_net_no(curr_net_no))
            {
    ...
    /**
     * Tries to make this trace shorter according to its org.thehellnet.tools.freerouting.rules.
    ...
    private int layer ; // org.thehellnet.tools.freerouting.board layer of the trace
}
