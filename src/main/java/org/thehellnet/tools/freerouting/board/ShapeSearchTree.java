...
import org.thehellnet.tools.freerouting.planar.ShapeBoundingDirections;
...
import org.thehellnet.tools.freerouting.planar.RegularTileShape;
import org.thehellnet.tools.freerouting.planar.Shape;
import org.thehellnet.tools.freerouting.planar.Side;
...
import org.thehellnet.tools.freerouting.rules.ClearanceMatrix;

import org.thehellnet.tools.freerouting.datastructures.Signum;

import org.thehellnet.tools.freerouting.autoroute.IncompleteFreeSpaceExpansionRoom;
 ...
 * of the MinAreaTree in the package org.thehellnet.tools.freerouting.datastructures.
 *
 *
 * @author Alfons Wirtz
 */
public class ShapeSearchTree extends org.thehellnet.tools.freerouting.datastructures.MinAreaTree
{
            ...
            Collection<TreeEntry> p_tree_entries)
    {
        ...
        {
            System.out.println("org.thehellnet.tools.freerouting.board.ShapeSearchTree.overlaps: p_obstacle_entries is null");
            return;
        }
        RegularTileShape bounds = p_shape.bounding_shape(bounding_directions);
        if (bounds == null)
        {
            System.out.println("org.thehellnet.tools.freerouting.board.ShapeSearchTree.overlaps: p_shape not bounded");
            return;
        }
            ...
            int p_cl_type, Collection<TreeEntry> p_obstacle_entries)
    {
        ...
        {
            System.out.println("org.thehellnet.tools.freerouting.board.ShapeSearchTree.overlaps_with_clearance: p_obstacle_entries is null");
            return;
        }
        ...
        if (bounds == null)
        {
            System.out.println("org.thehellnet.tools.freerouting.board.ShapeSearchTree.overlaps_with_clearance: p_shape is not bounded");
