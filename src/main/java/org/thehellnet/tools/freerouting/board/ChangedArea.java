...
/**
 *
 * Used internally for marking changed areas on the org.thehellnet.tools.freerouting.board
...
class ChangedArea
{
     ...
     */
    public void join (org.thehellnet.tools.freerouting.planar.TileShape p_shape, int p_layer)
    {
        if (p_shape == null)
        {
            return;
    ...
    /**
     * mutable octagon with double coordinates (see org.thehellnet.tools.freerouting.planar.IntOctagon)
     */
