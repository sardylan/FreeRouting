...
/**
 * Contains the lists of components on the org.thehellnet.tools.freerouting.board.
 *
 * @author  Alfons Wirtz
 */
public class Components implements java.io.Serializable
{
     ...
     * The items of the component have to be inserted seperately into the org.thehellnet.tools.freerouting.board.
    ...
    /**
     * Returns the number of components on the org.thehellnet.tools.freerouting.board.
     */
    public int count()
    {
     ...
     * Works contrary to Component.translate_by with the undo algorithm of the org.thehellnet.tools.freerouting.board.
     */
    public void move(int p_component_no, org.thehellnet.tools.freerouting.planar.Vector p_vector )
    {
     ...
     * Works contrary to Component.turn_90_degree with the undo algorithm of the org.thehellnet.tools.freerouting.board.
     */
     ...
     * Works contrary to Component.rotate with the undo algorithm of the org.thehellnet.tools.freerouting.board.
     */
     ...
     * Works contrary to Component.change_side the undo algorithm of the org.thehellnet.tools.freerouting.board.
     */
