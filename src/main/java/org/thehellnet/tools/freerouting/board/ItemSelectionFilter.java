...
/**
 * Filter for selecting items on the org.thehellnet.tools.freerouting.board.
 *
 * @author Alfons Wirtz
 */
public class ItemSelectionFilter implements java.io.Serializable
{
     ...
     */
    public Set<Item> filter(java.util.Set<org.thehellnet.tools.freerouting.board.Item> p_items)
    {
        Set<Item> result = new TreeSet<Item>();
        for (org.thehellnet.tools.freerouting.board.Item curr_item : p_items)
        {
