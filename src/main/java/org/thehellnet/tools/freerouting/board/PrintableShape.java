...
/**
 * Shape class used for printing a org.thehellnet.tools.freerouting.planar.Shape after transforming it to user coordinates.
 *
 * @author Alfons Wirtz
 */
    ...
    static class Circle extends PrintableShape
    {
        ...
        public String toString()
        {
            java.util.ResourceBundle resources = 
                    java.util.ResourceBundle.getBundle("board/ObjectInfoPanel", this.locale);
