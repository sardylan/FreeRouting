...
/**
 *
 * An item on the org.thehellnet.tools.freerouting.board with an relative_area shape, for example keepout, conduction relative_area
 *
 *
 *
 * @author Alfons Wirtz
...
public class ObstacleArea extends Item implements java.io.Serializable
{
    ...
    {
        return org.thehellnet.tools.freerouting.boardgraphics.Drawable.MIN_DRAW_PRIORITY;
    }
    ...
    protected final void print_shape_info(ObjectInfoPanel p_window, java.util.Locale p_locale)
    {
        ...
        org.thehellnet.tools.freerouting.planar.FloatPoint center = this.get_area().get_border().centre_of_gravity();
