...
public class Via extends DrillItem implements java.io.Serializable
{
    ...
    public org.thehellnet.tools.freerouting.autoroute.ExpansionDrill get_autoroute_drill_info(ShapeSearchTree p_autoroute_tree)
    {
        if (this.autoroute_drill_info == null)
        {
            org.thehellnet.tools.freerouting.autoroute.ItemAutorouteInfo via_autoroute_info = this.get_autoroute_info();
            TileShape curr_drill_shape = TileShape.get_instance(this.get_center());
            this.autoroute_drill_info =
                    new org.thehellnet.tools.freerouting.autoroute.ExpansionDrill(curr_drill_shape, this.get_center(), this.first_layer(), this.last_layer());
    ...
    transient private org.thehellnet.tools.freerouting.autoroute.ExpansionDrill autoroute_drill_info = null;
}
