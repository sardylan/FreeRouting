...
import org.thehellnet.tools.freerouting.planar.LineSegment;
...
import org.thehellnet.tools.freerouting.datastructures.Stoppable;
...
import org.thehellnet.tools.freerouting.autoroute.AutorouteControl;
import org.thehellnet.tools.freerouting.autoroute.AutorouteEngine;
import org.thehellnet.tools.freerouting.autoroute.AutorouteControl.ExpansionCostFactor;
import org.thehellnet.tools.freerouting.autoroute.CompleteFreeSpaceExpansionRoom;

/**
 *
 * Contains higher level functions of a org.thehellnet.tools.freerouting.board
 *
 * @author Alfons Wirtz
 */
public class RoutingBoard extends BasicBoard implements java.io.Serializable
{
    ...
    /**
     * marks the whole org.thehellnet.tools.freerouting.board as changed
     */
    ...
    /**
     * Initialises the org.thehellnet.tools.freerouting.autoroute database for routing a connection.
     * If p_retain_autoroute_database, the org.thehellnet.tools.freerouting.autoroute database is retained and maintained after
    ...
    /**
     * Clears the org.thehellnet.tools.freerouting.autoroute database in case it was retained.
     */
     ...
     */
    public AutorouteEngine.AutorouteResult autoroute(Item p_item, org.thehellnet.tools.freerouting.interactive.Settings p_settings, int p_via_costs, Stoppable p_stoppable_thread, TimeLimit p_time_limit)
    {
        ...
        {
            System.out.println("RoutingBoard.org.thehellnet.tools.freerouting.autoroute: net_count > 1 not yet implemented");
        }
        ...
        org.thehellnet.tools.freerouting.rules.Net route_net = rules.nets.get(route_net_no);
        if (route_net != null && route_net.contains_plane())
        {
            for (Item curr_item : route_start_set)
            {
                if (curr_item instanceof org.thehellnet.tools.freerouting.board.ConductionArea)
                {
     ...
     *  Returns an enum of type AutorouteEngine.AutorouteResult
     */
    public AutorouteEngine.AutorouteResult fanout(Pin p_pin, org.thehellnet.tools.freerouting.interactive.Settings p_settings, int p_ripup_costs,
    ...
    /**
     * Sets, if all conduction areas on the org.thehellnet.tools.freerouting.board are obstacles for route of foreign nets.
     */
    public void change_conduction_is_obstacle(boolean p_value)
    {
        ...
        // Change the is_obstacle property of all conduction areas of the org.thehellnet.tools.freerouting.board.
    ...
    /**
     * Sets, if the org.thehellnet.tools.freerouting.autoroute database has to be maintained outside the outoroute algorithm
     * while changing items on rhe org.thehellnet.tools.freerouting.board.
     */
    ...
    /**
     * Returns, if the org.thehellnet.tools.freerouting.autoroute database is maintained outside the outoroute algorithm
     * while changing items on rhe org.thehellnet.tools.freerouting.board.
     */
