 ...
 *   for more details.
 */
package org.thehellnet.tools.freerouting.board;

import org.thehellnet.tools.freerouting.planar.Area;
import org.thehellnet.tools.freerouting.planar.ConvexShape;
import org.thehellnet.tools.freerouting.planar.IntBox;
import org.thehellnet.tools.freerouting.planar.IntOctagon;
import org.thehellnet.tools.freerouting.planar.Point;
import org.thehellnet.tools.freerouting.planar.Vector;
import org.thehellnet.tools.freerouting.planar.Polyline;
...
import org.thehellnet.tools.freerouting.datastructures.ShapeTree.TreeEntry;

import org.thehellnet.tools.freerouting.library.BoardLibrary;
...
import org.thehellnet.tools.freerouting.boardgraphics.Drawable;
import org.thehellnet.tools.freerouting.datastructures.UndoableObjects;

/**
 *
 * Provides basic functionality of a org.thehellnet.tools.freerouting.board with geometric items.
 * Contains functions such as inserting, deleting, modifying
 * and picking items and elementary checking functions.
 * A org.thehellnet.tools.freerouting.board may have 1 or several layers.
 *
 * @author Alfons Wirtz
 */
public class BasicBoard implements java.io.Serializable
{
     ...
     * p_observers is used for syncronisation, if the org.thehellnet.tools.freerouting.board is generated
    ...
    /**
     * Inserts a trace into the org.thehellnet.tools.freerouting.board, whose geometry is described by
    ...
    /**
     * Inserts a via into the org.thehellnet.tools.freerouting.board. p_attach_allowed indicates, if the via may overlap with smd pins
     * of the same net.
     */
    ...
    /**
     * Inserts a pin into the org.thehellnet.tools.freerouting.board.
     *  p_pin_no is the number of this pin in the org.thehellnet.tools.freerouting.library package of its component (starting with 0).
     */
    ...
    /**
     * Inserts an obstacle into the org.thehellnet.tools.freerouting.board , whose geometry is described
    ...
    /**
     * Inserts an obstacle belonging to a component into the org.thehellnet.tools.freerouting.board
    ...
    /**
     * Inserts an via obstacle area into the org.thehellnet.tools.freerouting.board , whose geometry is described
     * by a polygonyal shape, which may have holes.
     */
    ...
    /**
     * Inserts an via obstacle belonging to a component into the org.thehellnet.tools.freerouting.board
     * p_name is to identify the corresponding ObstacstacleArea in the component package.
     */
    ...
    /**
     * Inserts a component obstacle area into the org.thehellnet.tools.freerouting.board , whose geometry is described
     * by a polygonyal shape, which may have holes.
     */
    ...
    /**
     * Inserts a component obstacle belonging to a component into the org.thehellnet.tools.freerouting.board.
     * p_name is to identify the corresponding ObstacstacleArea in the component package.
     */
    ...
    /**
     * Inserts a component ouline into the org.thehellnet.tools.freerouting.board.
     */
    ...
    /**
     * Inserts a condution area into the org.thehellnet.tools.freerouting.board , whose geometry is described
     * by a polygonyal shape, which may have holes.
    ...
    /**
     * Inserts an Outline into the org.thehellnet.tools.freerouting.board.
     */
    ...
    /**
     * Returns the outline of the org.thehellnet.tools.freerouting.board.
     */
    ...
    /**
     * Removes an item from the org.thehellnet.tools.freerouting.board
     */
    ...
    /**
     * looks, if an item with id_no p_id_no is on the org.thehellnet.tools.freerouting.board.
    ...
    /**
     * Returns the list of all items on the org.thehellnet.tools.freerouting.board
     */
    ...
    /**
     * Returns all connectable items on the org.thehellnet.tools.freerouting.board containing p_net_no
     */
    ...
    /**
     * Returns the list of all conduction areas on the org.thehellnet.tools.freerouting.board
     */
    ...
    /**
     * Returns the list of all pins on the org.thehellnet.tools.freerouting.board
     */
    ...
    /**
     * Returns the list of all pins on the org.thehellnet.tools.freerouting.board with only 1 layer
     */
    ...
    /**
     * Returns the list of all vias on the org.thehellnet.tools.freerouting.board
     */
    ...
    /**
     * Returns the list of all traces on the org.thehellnet.tools.freerouting.board
     */
    ...
    /**
     * Returns the cumulative length of all traces on the org.thehellnet.tools.freerouting.board
     */
    ...
    /**
     * Returns the layer count of this org.thehellnet.tools.freerouting.board.
     */
    ...
    /**
     * Draws all items of the org.thehellnet.tools.freerouting.board on their visible layers. Called in the overwritten
    ...
    public void draw(Graphics p_graphics, GraphicsContext p_graphics_context)
    {
        ...
        // draw all items on the org.thehellnet.tools.freerouting.board
    ...
    /**
     * Returns the list of items on the org.thehellnet.tools.freerouting.board, whose shape on layer p_layer contains the point at p_location.
     * If p_layer < 0, the layer is ignored.
    ...
    /**
     * checks, if p_point is contained in the bounding box of this org.thehellnet.tools.freerouting.board.
     */
    ...
    /**
     * returns the biggest half width of all traces on the org.thehellnet.tools.freerouting.board.
     */
    ...
    /**
     * returns the smallest half width of all traces on the org.thehellnet.tools.freerouting.board.
     */
    ...
    /**
     * Returns a surrounding box of the geometry of this org.thehellnet.tools.freerouting.board
     */
    ...
    /**
     * Returns, if the observer of the org.thehellnet.tools.freerouting.board items is activated.
     */
    ...
    /**
     * Inserts an item into the org.thehellnet.tools.freerouting.board data base
     */
    ...
    /**
     * Makes the current org.thehellnet.tools.freerouting.board situation restorable by undo.
     */
            ...
            throws java.io.IOException, java.lang.ClassNotFoundException
    {
        ...
        // insert the items on the org.thehellnet.tools.freerouting.board into the search trees
        search_tree_manager = new SearchTreeManager(this);
    ...
    /**
     * List of items inserted into this org.thehellnet.tools.freerouting.board
     */
    public final UndoableObjects item_list;
    /** List of placed components on the org.thehellnet.tools.freerouting.board. */
    public final Components components;
    /**
     * Class defining the org.thehellnet.tools.freerouting.rules for items to be inserted into this org.thehellnet.tools.freerouting.board.
     * Contains for example the clearance matrix.
     */
    public final BoardRules rules;
    /**
     * The org.thehellnet.tools.freerouting.library containing pastack masks, packagages and other
     * templates used on the org.thehellnet.tools.freerouting.board.
     */
    public final BoardLibrary library;
    /**
     * The layer structure of this org.thehellnet.tools.freerouting.board.
     */
    public final LayerStructure layer_structure;
    /**
     * Handels the search trees pointing into the items of this org.thehellnet.tools.freerouting.board
     */
    ...
    /**
     * bounding orthogonal rectangle of this org.thehellnet.tools.freerouting.board
     */
    ...
    /**
     * the biggest half width of all traces on the org.thehellnet.tools.freerouting.board
     */
    private int max_trace_half_width = 1000;
    /**
     * the smallest half width of all traces on the org.thehellnet.tools.freerouting.board
     */
