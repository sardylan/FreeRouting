...
import org.thehellnet.tools.freerouting.specctra.CoordinateTransform;
...
public class Communication implements java.io.Serializable
{
    ...
    public Communication()
    {
        this(Unit.MIL, 1, new SpecctraParserInfo("\"", null, null, null, null, false), 
                new CoordinateTransform(1, 0, 0), new org.thehellnet.tools.freerouting.board.ItemIdNoGenerator(), new BoardObserverAdaptor());
    }
