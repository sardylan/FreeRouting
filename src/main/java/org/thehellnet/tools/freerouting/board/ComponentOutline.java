...
public class ComponentOutline extends Item implements java.io.Serializable
{
    ...
    protected org.thehellnet.tools.freerouting.planar.TileShape[] calculate_tree_shapes(ShapeSearchTree p_search_tree)
    {
        return new org.thehellnet.tools.freerouting.planar.TileShape[0];
    }
    ...
    public org.thehellnet.tools.freerouting.planar.IntBox bounding_box()
    {
