...
import org.thehellnet.tools.freerouting.rules.Nets;
...
import org.thehellnet.tools.freerouting.datastructures.ShapeTree;
import org.thehellnet.tools.freerouting.datastructures.ShapeTree.TreeEntry;

/**
 * Basic class of the items on a org.thehellnet.tools.freerouting.board.
 *
 * @author Alfons Wirtz
 */
public abstract class Item implements Drawable, SearchTreeObject, ObjectInfoPanel.Printable, UndoableObjects.Storable, Serializable
{
    ...
    public TileShape get_tile_shape(int p_index)
    {
        if (this.board == null)
        {
            System.out.println("Item.get_tile_shape: org.thehellnet.tools.freerouting.board is null");
            return null;
        }
     ...
     * the org.thehellnet.tools.freerouting.board.
     */
     ...
     * Does not move the item in the org.thehellnet.tools.freerouting.board.
     */
    public abstract void translate_by(Vector p_vector);

    /**
     * Turns this Item by p_factor times 90 degree around p_pole.
     * Does not update the item in the org.thehellnet.tools.freerouting.board.
     */
    ...
    /**
     *  Translates this item by p_vector in the org.thehellnet.tools.freerouting.board.
     */
    ...
    /**
     * Gets the information for the org.thehellnet.tools.freerouting.autoroute algorithm.
     * Creates it, if it does not yet exist.
     */
    public org.thehellnet.tools.freerouting.autoroute.ItemAutorouteInfo get_autoroute_info()
    {
        if (autoroute_info == null)
        {
            autoroute_info = new org.thehellnet.tools.freerouting.autoroute.ItemAutorouteInfo(this);
        }
     ...
     * Gets the information for the org.thehellnet.tools.freerouting.autoroute algorithm.
     */
    public org.thehellnet.tools.freerouting.autoroute.ItemAutorouteInfo get_autoroute_info_pur()
    {
        return autoroute_info;
    }

    /**
     * Clears the data allocated for the org.thehellnet.tools.freerouting.autoroute algorithm.
     */
    ...
    protected void print_net_info(ObjectInfoPanel p_window, java.util.Locale p_locale)
    {
        java.util.ResourceBundle resources =
                java.util.ResourceBundle.getBundle("board/ObjectInfoPanel", p_locale);
        for (int i = 0; i < this.net_count(); ++i)
        {
            p_window.append(", " + resources.getString("net") + " ");
            org.thehellnet.tools.freerouting.rules.Net curr_net = board.rules.nets.get(this.get_net_no(i));
    ...
    protected void print_fixed_info(ObjectInfoPanel p_window, java.util.Locale p_locale)
    {
        ...
        {
            java.util.ResourceBundle resources =
                    java.util.ResourceBundle.getBundle("board/FixedState", p_locale);
            p_window.append(", ");
    ...
    /** The org.thehellnet.tools.freerouting.board this Itewm is on */
    ...
    /**
     * Folse, if the item is deleted or not inserted into the org.thehellnet.tools.freerouting.board
     */
    private boolean on_the_board = false;
    /** Temporary data used in the org.thehellnet.tools.freerouting.autoroute algorithm. */
    transient private org.thehellnet.tools.freerouting.autoroute.ItemAutorouteInfo autoroute_info = null;
