...
public abstract class DrillItem extends Item implements Connectable, java.io.Serializable
{
    ...
    {
        return org.thehellnet.tools.freerouting.boardgraphics.Drawable.MIDDLE_DRAW_PRIORITY;
    }
    
    public void draw(java.awt.Graphics p_g, org.thehellnet.tools.freerouting.boardgraphics.GraphicsContext p_graphics_context,
