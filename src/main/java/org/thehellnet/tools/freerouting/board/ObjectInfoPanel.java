...
/**
 * Output window for printing information about org.thehellnet.tools.freerouting.board objects.
 *
 * @author Alfons Wirtz
 */
public interface ObjectInfoPanel
{
     ...
     * Returns false, if that was not possible.
     */
    boolean append(org.thehellnet.tools.freerouting.planar.FloatPoint p_point);
     ...
     * Returns false, if that was not possible.
     */
    boolean append(org.thehellnet.tools.freerouting.planar.Shape p_shape, java.util.Locale p_locale);
     ...
     */
    boolean append_items( String p_link_name, String p_window_title, java.util.Collection<org.thehellnet.tools.freerouting.board.Item> p_items);
