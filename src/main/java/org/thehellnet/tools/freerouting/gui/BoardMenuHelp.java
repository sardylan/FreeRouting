...
public class BoardMenuHelp extends BoardMenuHelpReduced
{
     ...
     * Separated from BoardMenuHelpReduced to avoid ClassNotFound exception when the org.thehellnet.tools.freerouting.library
    ...
    {
        // try to find the org.thehellnet.tools.freerouting.helpset and create a HelpBroker object
        if (BoardFrame.help_broker == null)
        {
            ...
            if (BoardFrame.help_broker != null)
            {
                // CSH.DisplayHelpFromSource is a convenience class to display the org.thehellnet.tools.freerouting.helpset
