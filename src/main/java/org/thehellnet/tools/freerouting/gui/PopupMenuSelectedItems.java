...
/**
 * Popup menu used in the org.thehellnet.tools.freerouting.interactive selected item state..
 *
 * @author Alfons Wirtz
 */
class PopupMenuSelectedItems extends PopupMenuDisplay
{
    ...
    PopupMenuSelectedItems(BoardFrame p_board_frame)
    {
        ...
        copy_item.addActionListener(new java.awt.event.ActionListener()
        {
            ...
            {
                board_panel.boardHandling.copy_selected_items(board_panel.right_button_click_location);
            }
        });
        ...
        move_item.addActionListener(new java.awt.event.ActionListener()
        {
            public void actionPerformed(java.awt.event.ActionEvent evt)
            {
                board_panel.boardHandling.move_selected_items(board_panel.right_button_click_location);
            }
        });
