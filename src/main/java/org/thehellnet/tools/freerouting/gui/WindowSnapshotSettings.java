...
/**
 * Window for the settinngs of org.thehellnet.tools.freerouting.interactive snapshots.
 *
 * @author Alfons Wirtz
 */
public class WindowSnapshotSettings extends BoardSavableSubWindow
{
    ...
    public WindowSnapshotSettings(BoardFrame p_board_frame)
    {
        ...
        java.util.ResourceBundle resources = 
                java.util.ResourceBundle.getBundle("gui/WindowSnapshotSettings", p_board_frame.get_locale());
        ...
        // add check box for the org.thehellnet.tools.freerouting.interactive state
