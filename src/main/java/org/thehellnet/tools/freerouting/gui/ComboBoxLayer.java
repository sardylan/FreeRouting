...
/**
 * A Combo Box with items for individuell org.thehellnet.tools.freerouting.board layers plus an additional item for all layers.
 *
 * @author Alfons Wirtz
 */
public class ComboBoxLayer extends javax.swing.JComboBox
{
    ...
    {     
        java.util.ResourceBundle resources = 
                java.util.ResourceBundle.getBundle("gui/Default", p_locale);
        ...
        {
            ++curr_layer_no;
            org.thehellnet.tools.freerouting.board.Layer curr_signal_layer = p_layer_structure.get_signal_layer(i);
    ...
    /**
     * Layers of the org.thehellnet.tools.freerouting.board layer structure plus layer "all".
     * Index is the layer number in the org.thehellnet.tools.freerouting.board layer structure or -1 for layer "all".
     */
    public static class Layer
    {
        ...
        /** The index in the org.thehellnet.tools.freerouting.board layer_structure, -1 for the layers with name "all" or "inner" */
        final int index;
    }
