...
public class WindowRouteStubs extends WindowObjectListWithFilter
{
    ...
    protected void fill_list()
    {
        ...
        for (Item curr_item : board_items)
        {
            ...
            if (curr_item instanceof org.thehellnet.tools.freerouting.board.Via)
            {
                ...
                stub_location = ((org.thehellnet.tools.freerouting.board.Via)curr_item).get_center().to_float();
            }
            else
            {
                org.thehellnet.tools.freerouting.board.Trace curr_trace = (org.thehellnet.tools.freerouting.board.Trace) curr_item;
    ...
    private class RouteStubInfo implements Comparable<RouteStubInfo>
    {
        ...
        {
            String item_string;
            if (this.stub_item instanceof org.thehellnet.tools.freerouting.board.Trace)
            {
