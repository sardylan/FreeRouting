...
import org.thehellnet.tools.freerouting.boardgraphics.ColorIntensityTable.ObjectNames;

/**
 * Interactive Frame to adjust the visibility of the individual org.thehellnet.tools.freerouting.board items
 *
 * @author  alfons
 */
public class WindowObjectVisibility extends WindowVisibility
{
    ...
    public static WindowObjectVisibility get_instance(BoardFrame p_board_frame)
    {
        java.util.ResourceBundle resources = 
                java.util.ResourceBundle.getBundle("gui/WindowObjectVisibility", p_board_frame.get_locale());
    ...
    public void refresh()
    {
        org.thehellnet.tools.freerouting.boardgraphics.ColorIntensityTable color_intensity_table = this.get_board_handling().graphics_context.color_intensity_table;
