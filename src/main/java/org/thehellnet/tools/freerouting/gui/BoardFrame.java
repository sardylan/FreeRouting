...
import org.thehellnet.tools.freerouting.interactive.ScreenMessages;

import java.io.File;

import org.thehellnet.tools.freerouting.datastructures.FileFilter;
import org.thehellnet.tools.freerouting.datastructures.IdNoGenerator;

import org.thehellnet.tools.freerouting.board.TestLevel;
import org.thehellnet.tools.freerouting.board.BoardObservers;

import org.thehellnet.tools.freerouting.specctra.DsnFile;

/**
 *
 * Graphical frame of for org.thehellnet.tools.freerouting.interactive editing of a routing org.thehellnet.tools.freerouting.board.
 *
 * @author  Alfons Wirtz
 */
...
public class BoardFrame extends javax.swing.JFrame
{
    ...
    /**
     * Creates a new org.thehellnet.tools.freerouting.board frame with the input design file imbedded into a host cad software.
     */
    ...
    {
        final org.thehellnet.tools.freerouting.gui.DesignFile design_file = org.thehellnet.tools.freerouting.gui.DesignFile.get_instance(p_design_file_path_name, false);
        if (design_file == null)
        {
            WindowMessage.show("designfile not found");
            return null;
        }
        org.thehellnet.tools.freerouting.gui.BoardFrame board_frame = new org.thehellnet.tools.freerouting.gui.BoardFrame(design_file, org.thehellnet.tools.freerouting.gui.BoardFrame.Option.SINGLE_FRAME,
     ...
     * Currently Option.EXTENDED_TOOL_BAR is used only if a new org.thehellnet.tools.freerouting.board is
            ...
            java.util.Locale p_locale, boolean p_confirm_cancel)
    {
        this(p_design, p_option, p_test_level,
                new org.thehellnet.tools.freerouting.board.BoardObserverAdaptor(), new org.thehellnet.tools.freerouting.board.ItemIdNoGenerator(),
    ...
    BoardFrame(DesignFile p_design, Option p_option, TestLevel p_test_level, BoardObservers p_observers,
               org.thehellnet.tools.freerouting.datastructures.IdNoGenerator p_item_id_no_generator, java.util.Locale p_locale, boolean p_confirm_cancel)
    {
        ...
        this.resources = java.util.ResourceBundle.getBundle("gui/BoardFrame", p_locale);
    ...
    /**
     * Reads org.thehellnet.tools.freerouting.interactive actions from a logfile.
     */
    ...
    /**
     * Reads an existing org.thehellnet.tools.freerouting.board design from file.
    ...
    boolean read(java.io.InputStream p_input_stream, boolean p_is_import, javax.swing.JTextField p_message_field)
    {
        ...
        if (p_is_import)
        {
            // Read the default org.thehellnet.tools.freerouting.gui settings, if org.thehellnet.tools.freerouting.gui default file exists.
    ...
    /**
     * Saves the org.thehellnet.tools.freerouting.interactive settings and the design file to disk.
    ...
    /**
     * Calculates the absolute location of the org.thehellnet.tools.freerouting.board frame in his outmost parent frame.
     */
    ...
    /**
     * Creates the additional frames of the org.thehellnet.tools.freerouting.board frame.
     */
    ...
    /**
     * Sets the background of the org.thehellnet.tools.freerouting.board panel
     */
    ...
    /**
     * Repaints this org.thehellnet.tools.freerouting.board frame and all the subwindows of the org.thehellnet.tools.freerouting.board.
     */
    ...
    /** The scroll pane for the panel of the routing org.thehellnet.tools.freerouting.board. */
    ...
    private final org.thehellnet.tools.freerouting.datastructures.IdNoGenerator item_id_no_generator;
