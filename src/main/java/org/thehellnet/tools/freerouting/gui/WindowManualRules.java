...
/**
 * Used for manual choice of trace widths in org.thehellnet.tools.freerouting.interactive routing.
 *
 * @author  Alfons Wirtz
 */
public class WindowManualRules extends BoardSavableSubWindow
{
    ...
    public WindowManualRules(BoardFrame p_board_frame)
    {
        ...
        java.util.ResourceBundle resources =
                java.util.ResourceBundle.getBundle("gui/WindowManualRule", p_board_frame.get_locale());
        ...
        org.thehellnet.tools.freerouting.board.RoutingBoard routing_board = this.board_handling.get_routing_board();
    ...
    public void refresh()
    {
        org.thehellnet.tools.freerouting.board.RoutingBoard routing_board = board_handling.get_routing_board();
        ...
        org.thehellnet.tools.freerouting.rules.ClearanceMatrix clearance_matrix = board_handling.get_routing_board().rules.clearance_matrix;
