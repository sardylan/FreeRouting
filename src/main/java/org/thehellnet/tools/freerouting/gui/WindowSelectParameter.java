...
/**
 * Window for the handling of the org.thehellnet.tools.freerouting.interactive selection parameters,
 *
 * @author  Alfons Wirtz
 */
public class WindowSelectParameter extends BoardSavableSubWindow
{
    ...
    public void refresh()
    {
        ...
        org.thehellnet.tools.freerouting.board.LayerStructure layer_structure = this.board_handling.get_routing_board().layer_structure;
        org.thehellnet.tools.freerouting.board.Layer current_layer = layer_structure.arr[this.board_handling.settings.get_layer()];
