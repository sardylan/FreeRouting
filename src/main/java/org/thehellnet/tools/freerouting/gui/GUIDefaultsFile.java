...
/**
 * Description of a text file,  where the org.thehellnet.tools.freerouting.board independent org.thehellnet.tools.freerouting.interactive settings are stored.
 *
 * @author Alfons Wirtz
 */
...
{
    /**
     * Keywords in the org.thehellnet.tools.freerouting.gui defaults file.
     */
    enum Keyword
    {
     ...
     */
    public static boolean write(org.thehellnet.tools.freerouting.gui.BoardFrame p_board_frame,
                                org.thehellnet.tools.freerouting.interactive.BoardHandling p_board_handling, java.io.OutputStream p_output_stream)
    {
     ...
     */
    public static boolean read(org.thehellnet.tools.freerouting.gui.BoardFrame p_board_frame,
                               org.thehellnet.tools.freerouting.interactive.BoardHandling p_board_handling, java.io.InputStream p_input_stream)
    {
    ...
    private GUIDefaultsFile(org.thehellnet.tools.freerouting.gui.BoardFrame p_board_frame, org.thehellnet.tools.freerouting.interactive.BoardHandling p_board_handling,
    ...
    {
        org.thehellnet.tools.freerouting.boardgraphics.GraphicsContext graphics_context = this.board_handling.graphics_context;
        out_file.start_scope();
    ...
    {
        org.thehellnet.tools.freerouting.interactive.SnapShot.Attributes attributes = this.board_handling.settings.get_snapshot_attributes();
        out_file.start_scope();
    ...
    private final org.thehellnet.tools.freerouting.gui.BoardFrame board_frame;
