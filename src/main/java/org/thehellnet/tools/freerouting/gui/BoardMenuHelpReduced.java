...
public class BoardMenuHelpReduced extends javax.swing.JMenu
{
     ...
     * Separated from BoardMenuHelp to avoid ClassNotFound exception when the org.thehellnet.tools.freerouting.library
    ...
    public BoardMenuHelpReduced(BoardFrame p_board_frame)
    {
        ...
        this.resources = java.util.ResourceBundle.getBundle("gui/BoardMenuHelp", p_board_frame.get_locale());
