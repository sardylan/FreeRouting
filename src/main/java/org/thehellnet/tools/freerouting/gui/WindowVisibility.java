...
public abstract class WindowVisibility extends BoardSavableSubWindow
{
    ...
    protected org.thehellnet.tools.freerouting.interactive.BoardHandling get_board_handling()
    {
    ...
    /**
     * Stores the new value in the org.thehellnet.tools.freerouting.board database, when a slider value was changed.
     */
