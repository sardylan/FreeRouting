...
public class DesignFile
{
    ...
    /**
     * Saves the org.thehellnet.tools.freerouting.board rule to file, so that they can be reused later on.
     */
    private boolean write_rules_file(String p_design_name, org.thehellnet.tools.freerouting.interactive.BoardHandling p_board_handling)
    {
        ...
        else
        {
            ...
            {
                System.out.println("unable to create org.thehellnet.tools.freerouting.rules file");
                return false;
            }
        }
        org.thehellnet.tools.freerouting.specctra.RulesFile.write(p_board_handling, output_stream, p_design_name);
        return true;
    }

    public static boolean read_rules_file(String p_design_name, String p_parent_name,
                                          org.thehellnet.tools.freerouting.interactive.BoardHandling p_board_handling, boolean p_is_web_start, String p_confirm_message)
    {

        boolean result = true;
        String rule_file_name = p_design_name + ".org.thehellnet.tools.freerouting.rules";
        ...
        if (p_is_web_start)
        {
            ...
            {
                result = org.thehellnet.tools.freerouting.specctra.RulesFile.read(input_stream, p_design_name, p_board_handling);
                try
                {
                    input_stream.close();
                } catch (Exception e)
    ...
    private static final String RULES_FILE_EXTENSION = ".org.thehellnet.tools.freerouting.rules";
}
