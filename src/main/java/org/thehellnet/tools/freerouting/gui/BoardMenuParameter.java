...
/**
 * Creates the parameter menu of a org.thehellnet.tools.freerouting.board frame.
 *
 * @author Alfons Wirtz
 */
public class BoardMenuParameter extends javax.swing.JMenu
{
    ...
    private BoardMenuParameter(BoardFrame p_board_frame)
    {
        ...
        resources = java.util.ResourceBundle.getBundle("gui/BoardMenuParameter", p_board_frame.get_locale());
    }
