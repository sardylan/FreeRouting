...
/**
 * Creates the file menu of a org.thehellnet.tools.freerouting.board frame.
 *
 * @author Alfons Wirtz
 */
public class BoardMenuFile extends javax.swing.JMenu
{
    ...
    /** Returns a new file menu for the org.thehellnet.tools.freerouting.board frame. */
    ...
    public void add_design_dependent_items()
    {
        ...
        if ((routing_board.get_test_level() != org.thehellnet.tools.freerouting.board.TestLevel.RELEASE_VERSION || !host_cad_is_eagle))
        {
    ...
    /**
     * Adds a menu item for saving the current org.thehellnet.tools.freerouting.interactive settings as default.
     */
    ...
    private BoardMenuFile(BoardFrame p_board_frame, boolean p_session_file_option)
    {
        ...
        resources = java.util.ResourceBundle.getBundle("gui/BoardMenuFile", p_board_frame.get_locale());
    }
