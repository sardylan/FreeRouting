...
/**
 * Creates the org.thehellnet.tools.freerouting.rules menu of a org.thehellnet.tools.freerouting.board frame.
 *
 * @author Alfons Wirtz
 */
public class BoardMenuRules extends javax.swing.JMenu
{
    ...
    /** Returns a new windows menu for the org.thehellnet.tools.freerouting.board frame. */
    ...
    private BoardMenuRules(BoardFrame p_board_frame)
    {
        ...
        resources = java.util.ResourceBundle.getBundle("gui/BoardMenuRules", p_board_frame.get_locale());
    }
