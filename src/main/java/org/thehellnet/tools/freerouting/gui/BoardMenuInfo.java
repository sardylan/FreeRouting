...
{
    /** Returns a new info menu for the org.thehellnet.tools.freerouting.board frame. */
    ...
    private BoardMenuInfo(BoardFrame p_board_frame)
    {
        ...
        resources = java.util.ResourceBundle.getBundle("gui/BoardMenuInfo", p_board_frame.get_locale());
    }
