...
import org.thehellnet.tools.freerouting.board.BoardOutline;

/**
 *  Window handling detail parameters of the org.thehellnet.tools.freerouting.interactive routing.
 *
 * @author  Alfons Wirtz
 */
public class WindowRouteDetail extends BoardSavableSubWindow
{
    ...
    public WindowRouteDetail(BoardFrame p_board_frame)
    {
        ...
        java.util.ResourceBundle resources =
                java.util.ResourceBundle.getBundle("gui/WindowRouteDetail", p_board_frame.get_locale());
