...
/**
 * Panel at the lower border of the org.thehellnet.tools.freerouting.board frame containing amongst others the message line
...
class BoardPanelStatus extends javax.swing.JPanel
{
    ...
    BoardPanelStatus(java.util.Locale p_locale)
    {
        java.util.ResourceBundle resources =
                java.util.ResourceBundle.getBundle("gui/BoardPanelStatus", p_locale);
