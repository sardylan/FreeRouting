...
/**
 * Interactive Frame to adjust the visibility of the individual org.thehellnet.tools.freerouting.board layers
 *
 * @author  alfons
 */
public class WindowLayerVisibility extends WindowVisibility
{
    ...
    public void refresh()
    {
        org.thehellnet.tools.freerouting.boardgraphics.GraphicsContext graphics_context = this.get_board_handling().graphics_context;
