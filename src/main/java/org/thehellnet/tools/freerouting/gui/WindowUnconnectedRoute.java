...
public class WindowUnconnectedRoute extends WindowObjectListWithFilter
{
    ...
    {
        super(p_board_frame);
        this.resources = java.util.ResourceBundle.getBundle("gui/CleanupWindows", p_board_frame.get_locale());
    ...
    protected void fill_list()
    {
        ...
        {
            if (!(curr_item instanceof org.thehellnet.tools.freerouting.board.Trace || curr_item instanceof org.thehellnet.tools.freerouting.board.Via))
            {
                continue;
            }
            ...
            for (Item curr_connnected_item : curr_connected_set)
            {
                ...
                if (!(curr_connnected_item instanceof org.thehellnet.tools.freerouting.board.Trace || curr_connnected_item instanceof org.thehellnet.tools.freerouting.board.Via))
                {
            ...
            if (!terminal_item_found)
            {
                ...
                {
                    org.thehellnet.tools.freerouting.rules.Net curr_net = routing_board.rules.nets.get(curr_item.get_net_no(0));
                    if (curr_net != null)
                    {
    ...
    protected void select_instances()
    {
        ...
        Set<org.thehellnet.tools.freerouting.board.Item> selected_items = new java.util.TreeSet<org.thehellnet.tools.freerouting.board.Item>();
    ...
    {
        public UnconnectedRouteInfo(org.thehellnet.tools.freerouting.rules.Net p_net, Collection<Item> p_item_list)
        {
            this.net = p_net;
            ...
            for (Item curr_item: p_item_list)
            {
                ...
                else if (curr_item instanceof org.thehellnet.tools.freerouting.board.Via)
                {
                    ++curr_via_count;
                }
            }
        ...
        private final org.thehellnet.tools.freerouting.rules.Net net;
