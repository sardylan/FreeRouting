...
import org.thehellnet.tools.freerouting.board.Layer;

/**
 * Window for org.thehellnet.tools.freerouting.interactive editing of via org.thehellnet.tools.freerouting.rules.
 *
 * @author Alfons Wirtz
 */
public class WindowVia extends BoardSavableSubWindow
{
    ...
    {
        this.resources = java.util.ResourceBundle.getBundle("gui/WindowVia", p_board_frame.get_locale());
        ...
        // Add buttons to edit the via org.thehellnet.tools.freerouting.rules.
    ...
    private class ShowPadstacksListener implements java.awt.event.ActionListener
    {
        public void actionPerformed(java.awt.event.ActionEvent p_evt)
        {
            ...
            org.thehellnet.tools.freerouting.library.BoardLibrary board_library = board_frame.board_panel.board_handling.get_routing_board().library;
    ...
    private class AddPadstackListener implements java.awt.event.ActionListener
    {
        public void actionPerformed(java.awt.event.ActionEvent p_evt)
        {
            org.thehellnet.tools.freerouting.board.BasicBoard pcb = board_frame.board_panel.board_handling.get_routing_board();
            ...
            {
                Layer[] possible_start_layers = new  org.thehellnet.tools.freerouting.board.Layer[pcb.layer_structure.arr.length - 1];
            ...
            if (!layers_selected)
            {
                ...
                Layer[] possible_end_layers = new  org.thehellnet.tools.freerouting.board.Layer[pcb.layer_structure.arr.length - first_possible_end_layer_no];
            ...
            org.thehellnet.tools.freerouting.planar.ConvexShape[] padstack_shapes = new org.thehellnet.tools.freerouting.planar.ConvexShape[pcb.layer_structure.arr.length];
            org.thehellnet.tools.freerouting.board.CoordinateTransform coordinate_transform = board_frame.board_panel.board_handling.coordinate_transform;
            ...
            for (int i = from_layer_no; i <= to_layer_no; ++i)
            {
                ...
                if (circle_radius > 0)
                {
                    padstack_shapes[i] = new  org.thehellnet.tools.freerouting.planar.Circle(org.thehellnet.tools.freerouting.planar.Point.ZERO, circle_radius);
                    shape_exists = true;
                }
            }
            if (!shape_exists)
            ...
            org.thehellnet.tools.freerouting.library.Padstack new_padstack = pcb.library.padstacks.add(padstack_name, padstack_shapes, true, true);
    ...
    private class RemovePadstackListener implements java.awt.event.ActionListener
    {
        ...
        {
            org.thehellnet.tools.freerouting.board.BasicBoard pcb = board_frame.board_panel.board_handling.get_routing_board();
            org.thehellnet.tools.freerouting.library.Padstack[] via_padstacks = pcb.library.get_via_padstacks();
            ...
            org.thehellnet.tools.freerouting.library.Padstack selected_padstack = (org.thehellnet.tools.freerouting.library.Padstack)selected_value;
            org.thehellnet.tools.freerouting.rules.ViaInfo via_with_selected_padstack = null;
    ...
    private class ShowViasListener implements java.awt.event.ActionListener
    {
        ...
        {
            java.util.Collection<WindowObjectInfo.Printable> object_list = new java.util.LinkedList<WindowObjectInfo.Printable>();
            org.thehellnet.tools.freerouting.rules.ViaInfos via_infos = board_frame.board_panel.board_handling.get_routing_board().rules.via_infos;
