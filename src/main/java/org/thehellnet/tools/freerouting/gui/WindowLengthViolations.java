...
import org.thehellnet.tools.freerouting.interactive.RatsNest;
...
public class WindowLengthViolations  extends WindowObjectListWithFilter
{
    ...
    {
        super(p_board_frame);
        this.resources = java.util.ResourceBundle.getBundle("gui/WindowLengthViolations", p_board_frame.get_locale());
