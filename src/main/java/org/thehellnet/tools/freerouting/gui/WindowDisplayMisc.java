...
/**
 * Window for org.thehellnet.tools.freerouting.interactive changing of miscellanious display properties.
 *
 * @author Alfons Wirtz
 */
public class WindowDisplayMisc extends BoardSavableSubWindow
{
    ...
    public WindowDisplayMisc(BoardFrame p_board_frame)
    {
        ...
        // Add label and buttongroup for the rotation of the org.thehellnet.tools.freerouting.board.
        ...
        // add label and buttongroup for the mirroring of the org.thehellnet.tools.freerouting.board.
    ...
    private class MirrorNoneListener implements java.awt.event.ActionListener
    {
        public void actionPerformed(java.awt.event.ActionEvent p_evt)
        {
            ...
            // remember the old viewort center to retain the displayed section of the org.thehellnet.tools.freerouting.board.
            org.thehellnet.tools.freerouting.planar.FloatPoint old_viewport_center =
