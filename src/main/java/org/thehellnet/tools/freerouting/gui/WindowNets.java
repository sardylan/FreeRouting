...
public class WindowNets extends WindowObjectListWithFilter
{
    ...
    {
        super(p_board_frame);
        this.resources = java.util.ResourceBundle.getBundle("gui/WindowNets", p_board_frame.get_locale());
    ...
    private class AssignClassListener implements java.awt.event.ActionListener
    {
        public void actionPerformed(java.awt.event.ActionEvent p_evt)
        {
            ...
            if (!(selected_value instanceof org.thehellnet.tools.freerouting.rules.NetClass))
            {
                return;
            }
            org.thehellnet.tools.freerouting.rules.NetClass selected_class = (org.thehellnet.tools.freerouting.rules.NetClass) selected_value;
            for (int i = 0; i < selected_nets.length; ++i)
            {
