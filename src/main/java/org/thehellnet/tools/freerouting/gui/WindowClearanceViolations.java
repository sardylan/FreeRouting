...
import org.thehellnet.tools.freerouting.board.ClearanceViolation;

import org.thehellnet.tools.freerouting.interactive.ClearanceViolations;
...
public class WindowClearanceViolations extends WindowObjectListWithFilter
{
    ...
    {
        super(p_board_frame);
        this.resources = java.util.ResourceBundle.getBundle("gui/WindowClearanceViolations", p_board_frame.get_locale());
    ...
    private String item_info(org.thehellnet.tools.freerouting.board.Item p_item)
    {
        String result;
        ...
        else if (p_item instanceof org.thehellnet.tools.freerouting.board.ObstacleArea)
        {
            result = resources.getString("keepout");
        }
        else if (p_item instanceof org.thehellnet.tools.freerouting.board.ViaObstacleArea)
        {
            result = resources.getString("via_keepout");
        }
        else if (p_item instanceof org.thehellnet.tools.freerouting.board.ComponentObstacleArea)
        {
            result = resources.getString("component_keepout");
        }
        else if (p_item instanceof org.thehellnet.tools.freerouting.board.BoardOutline)
        {
