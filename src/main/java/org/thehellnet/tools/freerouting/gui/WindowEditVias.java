...
import org.thehellnet.tools.freerouting.rules.ViaInfos;
...
public class WindowEditVias extends BoardSavableSubWindow
{
    ...
    {
        this.resources = java.util.ResourceBundle.getBundle("gui/WindowEditVias", p_board_frame.get_locale());
    ...
    private class AddViaListener implements java.awt.event.ActionListener
    {
        public void actionPerformed(java.awt.event.ActionEvent p_evt)
        {
            ...
            org.thehellnet.tools.freerouting.rules.NetClass default_net_class = routing_board.rules.get_default_net_class();
            ViaInfo new_via = new ViaInfo(new_name, routing_board.library.get_via_padstack(0),
                    default_net_class.default_item_clearance_classes.get(org.thehellnet.tools.freerouting.rules.DefaultItemClearanceClasses.ItemClass.VIA),
    ...
    private class ViaTableModel extends javax.swing.table.AbstractTableModel
    {
        ...
        public void setValueAt(Object p_value, int p_row, int p_col)
        {
            ...
            else if (p_col == ColumnName.PADSTACK.ordinal())
            {
                ...
                String new_name = (String) p_value;
                org.thehellnet.tools.freerouting.library.Padstack new_padstack = routing_board.library.get_via_padstack(new_name);
