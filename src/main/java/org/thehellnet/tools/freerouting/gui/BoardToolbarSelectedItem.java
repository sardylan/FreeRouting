...
/**
 * Describes the toolbar of the org.thehellnet.tools.freerouting.board frame, when it is in the selected item state.
 *
 * @author Alfons Wirtz
 */
class BoardToolbarSelectedItem extends javax.swing.JToolBar
{
    ...
    BoardToolbarSelectedItem(BoardFrame p_board_frame, boolean p_extended)
    {
        ...
        this.resources = 
                java.util.ResourceBundle.getBundle("gui/BoardToolbarSelectedItem", p_board_frame.get_locale());
