...
import org.thehellnet.tools.freerouting.rules.NetClass;
...
/**
 * Edit window for the table of net org.thehellnet.tools.freerouting.rules.
 *
 * @author Alfons Wirtz
 */
public class WindowNetClasses extends BoardSavableSubWindow
{
    ...
    {
        this.resources = java.util.ResourceBundle.getBundle("gui/WindowNetClasses", p_board_frame.get_locale());
    ...
    private class RemoveNetClassListener implements java.awt.event.ActionListener
    {
        ...
        public void actionPerformed(java.awt.event.ActionEvent p_evt)
        {
            ...
            {
                org.thehellnet.tools.freerouting.rules.Net curr_net = board_rules.nets.get(i);
    ...
    private class SelectClassesListener implements java.awt.event.ActionListener
    {
        ...
        public void actionPerformed(java.awt.event.ActionEvent p_evt)
        {
            ...
            org.thehellnet.tools.freerouting.rules.Nets nets = routing_board.rules.nets;
            ...
            for (org.thehellnet.tools.freerouting.board.Item curr_item : board_items)
            {
                ...
                {
                    org.thehellnet.tools.freerouting.rules.NetClass curr_net_class = nets.get(curr_item.get_net_no(i)).get_class();
        ...
        void set_trace_width_field(int p_rule_no, ComboBoxLayer.Layer p_layer)
        {
            ...
            else if (p_layer.index == ComboBoxLayer.INNER_LAYER_INDEX)
            {
                ...
                else
                {
                    ...
                    org.thehellnet.tools.freerouting.board.LayerStructure layer_structure = board_handling.get_routing_board().layer_structure;
