...
{
    /** Returns a new other menu for the org.thehellnet.tools.freerouting.board frame. */
    ...
    private BoardMenuOther(BoardFrame p_board_frame)
    {
        ...
        resources = java.util.ResourceBundle.getBundle("gui/BoardMenuOther", p_board_frame.get_locale());
    }
