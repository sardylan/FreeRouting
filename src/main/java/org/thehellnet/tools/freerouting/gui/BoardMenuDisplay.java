...
/**
 * Creates the display menu of a org.thehellnet.tools.freerouting.board frame.
 *
 * @author Alfons Wirtz
 */
public class BoardMenuDisplay extends javax.swing.JMenu
{
    /** Returns a new display menu for the org.thehellnet.tools.freerouting.board frame. */
    ...
    private BoardMenuDisplay(BoardFrame p_board_frame)
    {
        ...
        resources = java.util.ResourceBundle.getBundle("gui/BoardMenuDisplay", p_board_frame.get_locale());
    }
