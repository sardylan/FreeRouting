...
/**
 * Popup Menu used in the org.thehellnet.tools.freerouting.interactive select state.
 *
 * @author Alfons Wirtz
 */
class PopupMenuMain extends PopupMenuDisplay
{
    ...
    PopupMenuMain(BoardFrame p_board_frame)
    {
        ...
        java.util.ResourceBundle resources = 
                java.util.ResourceBundle.getBundle("gui/PopupMenuMain", p_board_frame.get_locale());
