...
/**
 * Implements the toolbar panel of the org.thehellnet.tools.freerouting.board frame.
 *
 * @author Alfons Wirtz
 */
class BoardToolbar extends javax.swing.JPanel
{
    ...
    BoardToolbar(BoardFrame p_board_frame)
    {
        ...
        java.util.ResourceBundle resources = 
                java.util.ResourceBundle.getBundle("gui/BoardToolbar", p_board_frame.get_locale());
        ...
        autoroute_button.addActionListener(new java.awt.event.ActionListener()
        {
            public void actionPerformed(java.awt.event.ActionEvent evt)
            {
                board_frame.boardPanel.boardHandling.start_batch_autorouter();
            }
        });
        ...
        unit_combo_box.setModel(new javax.swing.DefaultComboBoxModel(org.thehellnet.tools.freerouting.board.Unit.values()));
        ...
        unit_combo_box.addActionListener(new java.awt.event.ActionListener()
        {
            public void actionPerformed(java.awt.event.ActionEvent evt)
            {
                org.thehellnet.tools.freerouting.board.Unit new_unit = (org.thehellnet.tools.freerouting.board.Unit) unit_combo_box.getSelectedItem();
    ...
    {
        org.thehellnet.tools.freerouting.interactive.InteractiveState interactive_state = this.board_frame.boardPanel.boardHandling.get_interactive_state();
        if (interactive_state instanceof org.thehellnet.tools.freerouting.interactive.RouteMenuState)
        {
            this.route_button.setSelected(true);
        }
        else if (interactive_state instanceof org.thehellnet.tools.freerouting.interactive.DragMenuState)
        {
            this.drag_button.setSelected(true);
        }
        else if (interactive_state instanceof org.thehellnet.tools.freerouting.interactive.SelectMenuState)
        {
