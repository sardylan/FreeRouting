...
import org.thehellnet.tools.freerouting.datastructures.TimeLimit;
...
import org.thehellnet.tools.freerouting.planar.Ellipse;
...
import org.thehellnet.tools.freerouting.rules.ViaRule;
import org.thehellnet.tools.freerouting.rules.ViaInfo;
import org.thehellnet.tools.freerouting.rules.Net;
...
import org.thehellnet.tools.freerouting.board.DrillItem;
...
/**
 *
 * Functionality for org.thehellnet.tools.freerouting.interactive routing.
 *
 * @author Alfons Wirtz
 */
public class Route
{
     ...
     * the half width array in p_board.org.thehellnet.tools.freerouting.rules.
     */
    ...
    public boolean next_corner(FloatPoint p_corner)
    {
        ...
        // org.thehellnet.tools.freerouting.tests.Validate.check("before insert", org.thehellnet.tools.freerouting.board);
        ...
        // org.thehellnet.tools.freerouting.tests.Validate.check("after insert", org.thehellnet.tools.freerouting.board);
    ...
    /**
     * Changing the layer in org.thehellnet.tools.freerouting.interactive route and inserting a via.
    ...
    private boolean snap_to_smd_center(int p_layer)
    {
        ...
        org.thehellnet.tools.freerouting.board.Pin found_smd_pin = null;
        for (Item curr_item : picked_items)
        {
            if (curr_item instanceof org.thehellnet.tools.freerouting.board.Pin && curr_item.shares_net_no(this.net_no_arr))
            {
                org.thehellnet.tools.freerouting.board.Pin curr_pin = (org.thehellnet.tools.freerouting.board.Pin) curr_item;
    ...
    private Set<SwapPinInfo> calculate_swap_pin_infos()
    {
        ...
        {
            if (curr_item instanceof org.thehellnet.tools.freerouting.board.Pin)
            {
                Collection<org.thehellnet.tools.freerouting.board.Pin> curr_swapppable_pins = ((org.thehellnet.tools.freerouting.board.Pin) curr_item).get_swappable_pins();
                for (org.thehellnet.tools.freerouting.board.Pin curr_swappable_pin : curr_swapppable_pins)
                {
    ...
    public void draw(Graphics p_graphics, GraphicsContext p_graphics_context)
    {
        ...
        if (nearest_target_point != null && prev_corner != null)
        {
            ...
            if (max_trace_length > 0 || min_trace_length > 0 && length_matching_color_intensity > 0)
            {
                ...
                {
                    // max_trace_length not provided. Create an ellipse containing the whole org.thehellnet.tools.freerouting.board.
                    max_trace_length = 0.3 * org.thehellnet.tools.freerouting.planar.Limits.CRIT_INT;
                }
    ...
    {
        if (!(this.start_item instanceof org.thehellnet.tools.freerouting.board.Pin))
        {
            return this.prev_corner;
        }
        org.thehellnet.tools.freerouting.board.Pin start_pin = (org.thehellnet.tools.freerouting.board.Pin) this.start_item;
    ...
    {
        if (!(this.nearest_target_item instanceof org.thehellnet.tools.freerouting.board.Pin))
        {
            return p_from_corner;
        }
        org.thehellnet.tools.freerouting.board.Pin target_pin = (org.thehellnet.tools.freerouting.board.Pin) this.nearest_target_item;
    ...
    private class SwapPinInfo implements Comparable<SwapPinInfo>
    {
        ...
        SwapPinInfo(org.thehellnet.tools.freerouting.board.Pin p_pin)
        {
            pin = p_pin;
            incomplete = null;
            ...
            if (nearest_point != null)
            {
                incomplete = new org.thehellnet.tools.freerouting.planar.FloatLine(pin_center, nearest_point);
            }
        }
        ...
        final org.thehellnet.tools.freerouting.board.Pin pin;
        org.thehellnet.tools.freerouting.planar.FloatLine incomplete;
    }
}