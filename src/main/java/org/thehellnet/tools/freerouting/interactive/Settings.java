...
/**
 * Contains the values of the org.thehellnet.tools.freerouting.interactive settings of the org.thehellnet.tools.freerouting.board handling.
 *
 * @author  Alfons Wirtz
 */
public class Settings implements java.io.Serializable
{
    /** Creates a new org.thehellnet.tools.freerouting.interactive settings variable. */
    public Settings(RoutingBoard p_board,  Logfile p_logfile)
    {
        ...
        is_stitch_route = false; // else org.thehellnet.tools.freerouting.interactive routing is dynamic
    ...
    /** indicates if org.thehellnet.tools.freerouting.interactive selections are made on all visible layers or only on the current layer.*/
    public  boolean get_select_on_all_visible_layers()
    {
        return this.select_on_all_visible_layers;
    }
    
    /** Indicates if the routing rule selection is manual by the user or automatic by the net org.thehellnet.tools.freerouting.rules. */
    ...
    /** The filter used in org.thehellnet.tools.freerouting.interactive selection of org.thehellnet.tools.freerouting.board items. */
    ...
    /**
     * The index of the clearance class used for traces in org.thehellnet.tools.freerouting.interactive routing in the clearance matrix,
    ...
    /**
     * The index of the via rule used in routing in the org.thehellnet.tools.freerouting.board via org.thehellnet.tools.freerouting.rules if manual_route_selection is on.
     */
    ...
    /**
     * Enables or disables pushing obstacles in org.thehellnet.tools.freerouting.interactive routing
     */
    ...
    /**
     * Sets, if item selection is on all org.thehellnet.tools.freerouting.board layers or only
    ...
    /** Indicates, if the data of this class are not allowed to be changed in ineractive org.thehellnet.tools.freerouting.board editing. */
