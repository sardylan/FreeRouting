...
import org.thehellnet.tools.freerouting.board.Pin;
import org.thehellnet.tools.freerouting.board.Item;
import org.thehellnet.tools.freerouting.board.ObstacleArea;
...
import org.thehellnet.tools.freerouting.board.OptViaAlgo;
...
public class SelectedItemState extends InteractiveState
{
    ...
    public InteractiveState autoroute(Stoppable p_stoppable_thread)
    {
        ...
        for (Item curr_item : autoroute_item_list)
        {
            ...
            org.thehellnet.tools.freerouting.rules.Net route_net = hdlg.get_routing_board().rules.nets.get(curr_item.get_net_no(0));
            if (route_net != null)
            {
    ...
    {
        org.thehellnet.tools.freerouting.board.BasicBoard routing_board = this.hdlg.get_routing_board();
    ...
    /**
     * Removes items not selected by the current org.thehellnet.tools.freerouting.interactive filter from the selected item list.
     */
    ...
    {
        org.thehellnet.tools.freerouting.gui.WindowObjectInfo.display(this.item_list, hdlg.get_panel().board_frame, hdlg.coordinate_transform, new java.awt.Point(100, 100));
        return this;
    }
