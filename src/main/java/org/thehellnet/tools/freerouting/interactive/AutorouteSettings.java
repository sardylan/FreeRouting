...
/**
 * Contains the org.thehellnet.tools.freerouting.interactive settings for the autorouter.
 *
 * @author Alfons Wirtz
 */
public class AutorouteSettings implements java.io.Serializable
{
    ...
    public AutorouteSettings(RoutingBoard p_board)
    {
        ...
        // make more horizontal pefered direction, if the org.thehellnet.tools.freerouting.board is horizontal.
