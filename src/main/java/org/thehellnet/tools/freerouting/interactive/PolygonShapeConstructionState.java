...
public class PolygonShapeConstructionState extends CornerItemConstructionState
{
    ...
    /**
     * Inserts the polygon shape item into the org.thehellnet.tools.freerouting.board, if possible
    ...
    public InteractiveState complete()
    {
        ...
        if (construction_succeeded)
        {
            ...
            if (construction_succeeded)
            {
                ...
                hdlg.get_routing_board().insert_obstacle(obstacle_shape, hdlg.settings.layer, cl_class, org.thehellnet.tools.freerouting.board.FixedState.UNFIXED);
