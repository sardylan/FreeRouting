...
public class ScreenMessages
{
    ...
    {
        resources = java.util.ResourceBundle.getBundle("interactive/ScreenMessages", p_locale);
        locale = p_locale;
     ...
     * in org.thehellnet.tools.freerouting.interactive routing.
     */
    ...
    public void set_mouse_position(org.thehellnet.tools.freerouting.planar.FloatPoint p_pos)
    {
