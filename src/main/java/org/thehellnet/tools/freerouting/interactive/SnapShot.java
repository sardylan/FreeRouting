...
/**
 * Snapshot of the client situation in an org.thehellnet.tools.freerouting.interactive session.
 *
 * @author  Alfons Wirtz
 */
...
{
    /**
     * Returns a new snapshot or null, if the current org.thehellnet.tools.freerouting.interactive state
    ...
    /** Creates a SnapShot of the display region and the org.thehellnet.tools.freerouting.interactive settings */
    private SnapShot(String p_name, BoardHandling p_board_handling)
    {
        ...
        this.graphics_context = new org.thehellnet.tools.freerouting.boardgraphics.GraphicsContext(p_board_handling.graphics_context);
    ...
    /**
     * Goes to this shnapshot in org.thehellnet.tools.freerouting.interactive org.thehellnet.tools.freerouting.board etiting.
     */
    public void go_to(org.thehellnet.tools.freerouting.interactive.BoardHandling p_board_handling)
    {
        org.thehellnet.tools.freerouting.interactive.SnapShot.Attributes snapshot_attributes = this.settings.snapshot_attributes;

        if (snapshot_attributes.object_visibility)
        {
            p_board_handling.graphics_context.color_intensity_table =
                    new org.thehellnet.tools.freerouting.boardgraphics.ColorIntensityTable(this.graphics_context.color_intensity_table);
        }
        ...
        {
            p_board_handling.settings.item_selection_filter = new org.thehellnet.tools.freerouting.board.ItemSelectionFilter(this.settings.item_selection_filter);
        }
    ...
    /**
     * Create a number for writing an org.thehellnet.tools.freerouting.interactive state to disk.
    ...
    public final org.thehellnet.tools.freerouting.boardgraphics.GraphicsContext graphics_context;
    private final java.awt.Point viewport_position;
    public final org.thehellnet.tools.freerouting.gui.BoardFrame.SubwindowSelections subwindow_filters;
