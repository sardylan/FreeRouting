...
public class CopyItemState extends InteractiveState
{
    ...
    private void change_position(FloatPoint p_new_position)
    {
        ...
        if (!current_position.equals(previous_position))
        {
            ...
            Iterator<org.thehellnet.tools.freerouting.board.Item> it = item_list.iterator();
            while (it.hasNext())
            {
    ...
    /**
     * Inserts the items in the copy list into the org.thehellnet.tools.freerouting.board.
