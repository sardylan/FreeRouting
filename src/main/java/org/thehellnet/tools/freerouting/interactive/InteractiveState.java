...
public class InteractiveState
{
    ...
    protected InteractiveState(InteractiveState p_return_state, BoardHandling p_board_handling, Logfile p_logfile)
    {
        ...
        this.resources =
                java.util.ResourceBundle.getBundle("interactive/InteractiveState", p_board_handling.get_locale());
    }
    ...
    /**
     * Returns the popup menu from board_panel, which is used in this org.thehellnet.tools.freerouting.interactive state.
     * Default function to be overwritten in derived classes.
     */
    ...
    /** org.thehellnet.tools.freerouting.board setting access handler for the derived classes */
    protected final BoardHandling hdlg;
    
    /** The intended state after this state is finished */
    protected InteractiveState return_state;
    
    /** if logfile != null, the org.thehellnet.tools.freerouting.interactive actions are stored in a logfile */
