...
public class RatsNest
{
    ...
    /**
     * Used for  example to hide the incompletes during org.thehellnet.tools.freerouting.interactive routiing.
     */
     ...
     */
    public static class AirLine implements Comparable<AirLine>, org.thehellnet.tools.freerouting.board.ObjectInfoPanel.Printable
    {
        ...
        private String item_info(Item p_item)
        {
            java.util.ResourceBundle resources =
                    java.util.ResourceBundle.getBundle("interactive/RatsNest", this.locale);
            String result;
            if (p_item instanceof org.thehellnet.tools.freerouting.board.Pin)
            {
                org.thehellnet.tools.freerouting.board.Pin curr_pin = (org.thehellnet.tools.freerouting.board.Pin) p_item;
                result = curr_pin.component_name() + ", " + curr_pin.name();
            }
            else if (p_item instanceof org.thehellnet.tools.freerouting.board.Via)
            {
                result = resources.getString("via");
            }
            else if (p_item instanceof org.thehellnet.tools.freerouting.board.Trace)
            {
                result = resources.getString("trace");
            }
            else if (p_item instanceof org.thehellnet.tools.freerouting.board.ConductionArea)
            {
        ...
        {
            java.util.ResourceBundle resources =
                    java.util.ResourceBundle.getBundle("interactive/RatsNest", p_locale);
