...
/**
 * Class for org.thehellnet.tools.freerouting.interactive zooming to a rectangle.
 *
 * @author Alfons Wirtz
 */
public class ZoomRegionState extends SelectRegionState
{
    ...
    public ZoomRegionState(InteractiveState p_parent_state, BoardHandling p_board_handling, Logfile p_logfile)
    {
        ...
        {
            logfile.start_scope(org.thehellnet.tools.freerouting.interactive.LogfileScope.ZOOM_FRAME);
        }
    }
