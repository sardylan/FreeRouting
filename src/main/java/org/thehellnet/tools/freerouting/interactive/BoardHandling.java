 ...
 *
 */
package org.thehellnet.tools.freerouting.interactive;
...
import org.thehellnet.tools.freerouting.planar.FloatPoint;
import org.thehellnet.tools.freerouting.planar.IntBox;
import org.thehellnet.tools.freerouting.planar.IntPoint;
import org.thehellnet.tools.freerouting.planar.PolylineShape;

import org.thehellnet.tools.freerouting.rules.BoardRules;
import org.thehellnet.tools.freerouting.board.LayerStructure;
import org.thehellnet.tools.freerouting.board.RoutingBoard;
import org.thehellnet.tools.freerouting.board.Item;
import org.thehellnet.tools.freerouting.board.PolylineTrace;
import org.thehellnet.tools.freerouting.board.FixedState;
import org.thehellnet.tools.freerouting.board.ItemSelectionFilter;

import org.thehellnet.tools.freerouting.boardgraphics.GraphicsContext;
import org.thehellnet.tools.freerouting.board.CoordinateTransform;
import org.thehellnet.tools.freerouting.board.Unit;
import org.thehellnet.tools.freerouting.board.TestLevel;

import org.thehellnet.tools.freerouting.specctra.DsnFile;

/**
 *
 * Central connection class between the graphical user interface and
 * the org.thehellnet.tools.freerouting.board database.
 *
 * @author  Alfons Wirtz
 */
public class BoardHandling
{
     ...
     */
    public BoardHandling(org.thehellnet.tools.freerouting.gui.BoardPanel p_panel, java.util.Locale p_locale)
    {
        ...
        this.resources = java.util.ResourceBundle.getBundle("interactive/BoardHandling", p_locale);
    }

    /**
     * Sets the org.thehellnet.tools.freerouting.board to read only for example when running a seperate action thread
     * to avoid unsynchronized change of the org.thehellnet.tools.freerouting.board.
     */
    ...
    /**
     * Return true, if the org.thehellnet.tools.freerouting.board is set to read only.
     */
    ...
    /**
     * returns the number of layers of the org.thehellnet.tools.freerouting.board design.
     */
    ...
    /**
     * Gets the routing org.thehellnet.tools.freerouting.board of this org.thehellnet.tools.freerouting.board handling.
     */
    ...
    public void set_pin_edge_to_turn_dist(double p_value)
    {
        ...
        if (edge_to_turn_dist != board.rules.get_pin_edge_to_turn_dist())
        {
            ...
            Collection<org.thehellnet.tools.freerouting.board.Pin> pin_list = board.get_pins();
            for (org.thehellnet.tools.freerouting.board.Pin curr_pin : pin_list)
            {
    ...
    /**
     * Gets the trace half width used in org.thehellnet.tools.freerouting.interactive routing for the input net on the input layer.
     */
    ...
    /**
     *  Returns if p_layer is active for org.thehellnet.tools.freerouting.interactive routing of traces.
     */
    public boolean is_active_routing_layer(int p_net_no, int p_layer)
    {
        ...
        org.thehellnet.tools.freerouting.rules.Net curr_net = this.board.rules.nets.get(p_net_no);
        if (curr_net == null)
        {
            return true;
        }
        org.thehellnet.tools.freerouting.rules.NetClass curr_net_class = curr_net.get_class();
    ...
    /** Gets the trace clearance class used in org.thehellnet.tools.freerouting.interactive routing. */
    ...
    /** Gets the via rule used in org.thehellnet.tools.freerouting.interactive routing. */
    public org.thehellnet.tools.freerouting.rules.ViaRule get_via_rule(int p_net_no)
    {
        org.thehellnet.tools.freerouting.rules.ViaRule result = null;
        if (settings.manual_rule_selection)
        {
    ...
    /**
     * Changes the default trace halfwidth currently used in org.thehellnet.tools.freerouting.interactive routing on the input layer.
     */
    ...
    /**
     * Changes the current snap angle in the org.thehellnet.tools.freerouting.interactive org.thehellnet.tools.freerouting.board handling.
     */
    public void set_current_snap_angle(org.thehellnet.tools.freerouting.board.AngleRestriction p_snap_angle)
    {
        if (board_is_read_only)
        {
            return;
    ...
    /**
     * Changes the current layer in the org.thehellnet.tools.freerouting.interactive org.thehellnet.tools.freerouting.board handling.
     */
    ...
    {
        org.thehellnet.tools.freerouting.board.Layer curr_layer = board.layer_structure.arr[p_layer_no];
    ...
    public void display_layer_messsage()
    {
        ...
        org.thehellnet.tools.freerouting.board.Layer curr_layer = board.layer_structure.arr[this.settings.layer];
        screen_messages.set_layer(curr_layer.name);
    }

    /**
     * Initializes the manual trace widths from the default trace widths in the org.thehellnet.tools.freerouting.board org.thehellnet.tools.freerouting.rules.
     */
    ...
    /**
     * Sets the manual trace half width used in org.thehellnet.tools.freerouting.interactive routing.
    ...
    {
        if (p_layer_no == org.thehellnet.tools.freerouting.gui.ComboBoxLayer.ALL_LAYER_INDEX)
        {
            for (int i = 0; i < settings.manual_trace_half_width_arr.length; ++i)
            {
        ...
        else if (p_layer_no == org.thehellnet.tools.freerouting.gui.ComboBoxLayer.INNER_LAYER_INDEX)
        {
    ...
    /**
     * Changes the org.thehellnet.tools.freerouting.interactive selectability of p_item_type.
     */
    ...
    /**
     * Creates the Routingboard, the graphic context and the org.thehellnet.tools.freerouting.interactive settings.
     */
    public void create_board(IntBox p_bounding_box, LayerStructure p_layer_structure,
                             ...
                             BoardRules p_rules, org.thehellnet.tools.freerouting.board.Communication p_board_communication, TestLevel p_test_level)
    {
        if (this.board != null)
        {
            System.out.println(" BoardHandling.create_board: org.thehellnet.tools.freerouting.board already created");
        }
        ...
        if (p_rules != null)
        {
            ...
            {
                outline_cl_class_no =
                        p_rules.get_default_net_class().default_item_clearance_classes.get(org.thehellnet.tools.freerouting.rules.DefaultItemClearanceClasses.ItemClass.AREA);
            }
        }
        this.board =
        ...
        // create the org.thehellnet.tools.freerouting.interactive settings with default
        ...
        // create a graphics context for the org.thehellnet.tools.freerouting.board
    ...
    /**
     * From here on the org.thehellnet.tools.freerouting.interactive actions are written to a logfile.
     */
    ...
    /**
     * Repaints the org.thehellnet.tools.freerouting.board panel on the screen.
     */
    public void repaint()
    {
    ...
    /**
     * Repaints a rectangle of org.thehellnet.tools.freerouting.board panel on the screen.
     */
    ...
    /**
     * Gets the panel for graphical display of the org.thehellnet.tools.freerouting.board.
     */
    org.thehellnet.tools.freerouting.gui.BoardPanel get_panel()
    {
        return this.panel;
    }

    /**
     * Gets the popup menu used in the current org.thehellnet.tools.freerouting.interactive state.
    ...
    /**
     * Draws the org.thehellnet.tools.freerouting.board and all temporary construction graphics in the
     * current org.thehellnet.tools.freerouting.interactive state.
     */
    ...
    /**
     * Actions to be taken in the current org.thehellnet.tools.freerouting.interactive state
    ...
    public void left_button_clicked(Point2D p_point)
    {
        if (board_is_read_only)
        {
            ...
            {
                // The left button is used to stop the org.thehellnet.tools.freerouting.interactive action thread.
    ...
    public void mouse_moved(Point2D p_point)
    {
        if (board_is_read_only)
        {
            // no org.thehellnet.tools.freerouting.interactive action when logfile is running
            return;
        }
        if (interactive_state != null && graphics_context != null)
        {
            ...
            // performance in org.thehellnet.tools.freerouting.interactive route.
    ...
    /**
     * Action to be taken in the current org.thehellnet.tools.freerouting.interactive state
    ...
    /**
     * Completes the curreent org.thehellnet.tools.freerouting.interactive state and returns to
     * its return state.
     */
    ...
    /**
     * Cancels the current org.thehellnet.tools.freerouting.interactive state.
     */
    ...
    /**
     * Actions to be taken in the current org.thehellnet.tools.freerouting.interactive state when
     * the current org.thehellnet.tools.freerouting.board layer is changed.
    ...
    /**
     * Sets the org.thehellnet.tools.freerouting.interactive state to SelectMenuState
     */
    ...
    /**
     * Sets the org.thehellnet.tools.freerouting.interactive state to RouteMenuState
     */
    ...
    /**
     * Sets the org.thehellnet.tools.freerouting.interactive state to DragMenuState
     */
    ...
    /**
     * Reads an existing org.thehellnet.tools.freerouting.board design from the input stream.
     * Returns false,  if the input stream does not contains a legal org.thehellnet.tools.freerouting.board design.
     */
    ...
    /**
     * Imports a org.thehellnet.tools.freerouting.board design from a Specctra dsn-file.
     * The parameters p_item_observers and p_item_id_no_generator are used,
     * in case the org.thehellnet.tools.freerouting.board is embedded into a host system.
     * Returns false, if the dsn-file is currupted.
     */
    public DsnFile.ReadResult import_design(java.io.InputStream p_design,
                                            org.thehellnet.tools.freerouting.board.BoardObservers p_observers,
                                            org.thehellnet.tools.freerouting.datastructures.IdNoGenerator p_item_id_no_generator, TestLevel p_test_level)
    {
        if (p_design == null)
        {
    ...
    /**
     * Writes the currently edited org.thehellnet.tools.freerouting.board design to a text file in the Specctra dsn format.
    ...
    public boolean export_to_dsn_file(OutputStream p_output_stream, String p_design_name, boolean p_compat_mode)
    {
        ...
        return org.thehellnet.tools.freerouting.specctra.DsnFile.write(this, p_output_stream, p_design_name, p_compat_mode);
    }
    ...
    public boolean export_eagle_session_file(java.io.InputStream p_input_stream, OutputStream p_output_stream)
    {
        ...
        return org.thehellnet.tools.freerouting.specctra.SessionToEagle.get_instance(p_input_stream, p_output_stream, this.board);
    }
    ...
    public boolean export_specctra_session_file(String p_design_name, OutputStream p_output_stream)
    {
        ...
        return org.thehellnet.tools.freerouting.specctra.SessionFile.write(this.get_routing_board(), p_output_stream, p_design_name);
    }

    /**
     * Saves the currently edited org.thehellnet.tools.freerouting.board design to p_design_file.
     */
    ...
    /**
     * Starts org.thehellnet.tools.freerouting.interactive routing at the input location.
     */
    ...
    /**
     * Selects org.thehellnet.tools.freerouting.board items at the input location.
     */
    ...
    /**
     * Selects all items in an org.thehellnet.tools.freerouting.interactive defined rectangle.
     */
    ...
    /**
     * Zooms display to an org.thehellnet.tools.freerouting.interactive defined rectangle.
     */
     ...
     * on the org.thehellnet.tools.freerouting.board is started.
     */
     ...
     * graphics is needed caused by the previous org.thehellnet.tools.freerouting.interactive actions.
     */
    ...
    /**
     * Gets all items at p_location on the active org.thehellnet.tools.freerouting.board layer.
    ...
    /**
     * Gets all items at p_location on the active org.thehellnet.tools.freerouting.board layer with the inputt  item filter.
     * If nothing is found on the active layer and settings.select_on_all_layers
     * is true, all layers are selected.
     */
    ...
    /**
     * Gets the current org.thehellnet.tools.freerouting.interactive state.
     */
     ...
     * org.thehellnet.tools.freerouting.board outline are contained in the new bounds.
     */
    ...
    /** The graphical context for drawing the org.thehellnet.tools.freerouting.board. */
    public GraphicsContext graphics_context = null;
    /** For ransforming coordinates between the user and the org.thehellnet.tools.freerouting.board coordinate space */
    ...
    /** The current settings for org.thehellnet.tools.freerouting.interactive actions on the org.thehellnet.tools.freerouting.board*/
    public Settings settings = null;
    /** The currently active org.thehellnet.tools.freerouting.interactive state. */
    InteractiveState interactive_state = null;
    /**
     * Used for running an org.thehellnet.tools.freerouting.interactive action in a seperate thread.
     */
    ...
    /** The org.thehellnet.tools.freerouting.board database used in this org.thehellnet.tools.freerouting.interactive handling. */
    private RoutingBoard board = null;
    /** The graphical panel used for displaying the org.thehellnet.tools.freerouting.board. */
    private final org.thehellnet.tools.freerouting.gui.BoardPanel panel;
    /**
     * The file used for logging org.thehellnet.tools.freerouting.interactive action,
     * so that they can be replayed later
     */
    public final Logfile logfile;
    /**
     * True if currently a logfile is being processed.
     * Used to prevent org.thehellnet.tools.freerouting.interactive changes of the org.thehellnet.tools.freerouting.board database
     * in this case.
     */
    ...
    /**
     * To repaint the org.thehellnet.tools.freerouting.board immediately for example when reading a logfile.
     */
