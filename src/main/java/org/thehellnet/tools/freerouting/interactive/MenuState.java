...
public class MenuState extends InteractiveState
{
    ...
    public InteractiveState swap_pin(FloatPoint p_location)
    {
        ...
        if (picked_items.size() > 0)
        {
            ...
            if (!(first_item instanceof org.thehellnet.tools.freerouting.board.Pin))
            {
                System.out.println("MenuState.swap_pin: Pin expected");
                return this;
            }
            org.thehellnet.tools.freerouting.board.Pin selected_pin = (org.thehellnet.tools.freerouting.board.Pin) first_item;
