...
import org.thehellnet.tools.freerouting.datastructures.PlanarDelaunayTriangulation;
...
public class NetIncompletes
{
    ...
    public void draw(Graphics p_graphics, GraphicsContext p_graphics_context, boolean p_length_violations_only)
    {
        ...
        Collection<org.thehellnet.tools.freerouting.board.Pin> net_pins = this.net.get_pins();
        for (org.thehellnet.tools.freerouting.board.Pin curr_pin : net_pins)
        {
    ...
    private static class Edge implements Comparable<Edge>
    {
        ...
        public int compareTo(Edge p_other)
        {
            ...
            return org.thehellnet.tools.freerouting.datastructures.Signum.as_int(result);
        }
    }
