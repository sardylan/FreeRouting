...
import org.thehellnet.tools.freerouting.autoroute.InsertFoundConnectionAlgo;
import org.thehellnet.tools.freerouting.autoroute.LocateFoundConnectionAlgo;
import org.thehellnet.tools.freerouting.autoroute.MazeSearchAlgo;
...
public class ExpandTestState extends InteractiveState
{
    ...
    {
        // look if an org.thehellnet.tools.freerouting.autoroute can be started at the input location
        ...
        while (it.hasNext())
        {
            ...
            if (curr_ob instanceof org.thehellnet.tools.freerouting.board.Connectable)
            {
        ...
        {
            hdlg.screen_messages.set_status_message("org.thehellnet.tools.freerouting.autoroute test started");
    ...
    private void complete_autoroute()
    {
        ...
        if (search_result != null)
        {
            ...
            this.autoroute_result =
                    ...
                    ripped_item_list, org.thehellnet.tools.freerouting.board.TestLevel.ALL_DEBUGGING_OUTPUT);
