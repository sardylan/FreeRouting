...
import org.thehellnet.tools.freerouting.autoroute.BatchAutorouter;
import org.thehellnet.tools.freerouting.autoroute.BatchFanout;
import org.thehellnet.tools.freerouting.autoroute.BatchOptRoute;
...
public class BatchAutorouterThread extends InteractiveActionThread
{
    ...
    protected void thread_action()
    {
        try
        {
            ...
            if (hdlg.get_routing_board().rules.get_trace_angle_restriction() == org.thehellnet.tools.freerouting.board.AngleRestriction.FORTYFIVE_DEGREE && hdlg.get_routing_board().get_test_level() != org.thehellnet.tools.freerouting.board.TestLevel.RELEASE_VERSION)
            {
                org.thehellnet.tools.freerouting.tests.Validate.multiple_of_45_degree("after org.thehellnet.tools.freerouting.autoroute: ", hdlg.get_routing_board());
            }
        } catch (Exception e)
        {
