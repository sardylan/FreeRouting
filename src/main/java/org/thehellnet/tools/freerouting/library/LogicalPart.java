 ...
 * @author Alfons Wirtz
 */
public class LogicalPart implements org.thehellnet.tools.freerouting.board.ObjectInfoPanel.Printable, java.io.Serializable
{
    
    /**
     * Creates a new instance of LogicalPart.
     * The part pins are sorted by pin_no.
     * The pin_no's of the part pins must be the same number as in the componnents org.thehellnet.tools.freerouting.library package.
     */
    ...
    public static class PartPin implements Comparable<PartPin>, java.io.Serializable
    {
        ...
        /** The number of the part pin. Must be the same number as in the componnents org.thehellnet.tools.freerouting.library package. */
        public final int pin_no;
        
        /** The name of the part pin. Must be the same name as in the componnents org.thehellnet.tools.freerouting.library package. */
