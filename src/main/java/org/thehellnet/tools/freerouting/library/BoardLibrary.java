...
package org.thehellnet.tools.freerouting.library;

import java.util.List;
import java.util.Vector;

/**
 * Describes a org.thehellnet.tools.freerouting.board org.thehellnet.tools.freerouting.library of packages and padstacks.
 *
 * @author  alfons
 */
public class BoardLibrary implements java.io.Serializable
{
     ...
     * If the padstack is no more used on the org.thehellnet.tools.freerouting.board, it will also be removed from the org.thehellnet.tools.freerouting.board padstacks.
     */
    public boolean remove_via_padstack(Padstack p_padstack, org.thehellnet.tools.freerouting.board.BasicBoard p_board)
    {
    ...
    /**
     * Gets the via padstack mirrored to the back side of the org.thehellnet.tools.freerouting.board.
     ...
     */
    public boolean is_used (Padstack p_padstack, org.thehellnet.tools.freerouting.board.BasicBoard p_board)
    {
        ...
        for(;;)
        {
            org.thehellnet.tools.freerouting.datastructures.UndoableObjects.Storable curr_item = p_board.item_list.read_object(it);
            if (curr_item == null)
            {
                break;
            }
            if (curr_item instanceof org.thehellnet.tools.freerouting.board.DrillItem)
            {
                if (((org.thehellnet.tools.freerouting.board.DrillItem) curr_item).get_padstack() == p_padstack)
                {
                    return true;
                }
            }
    ...
    /** The subset of padstacks in the org.thehellnet.tools.freerouting.board org.thehellnet.tools.freerouting.library, which can be used in routing for inserting vias. */
